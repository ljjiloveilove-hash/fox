(async function () {
    ...
    const CONFIG = {
      ...
      { id: '7f73104d-56ee-4f70-9274-b64a915e46a1', name: '🎨 画图请打开'
        ...
        SELECT_GROUPS: [
      { label: '📝 文风要求', options: [
          { name: '✨ 真实感', id: 'd6292de5-e1a1-4f94-93eb-bda00453020c'
          },
          { name: '📖 轻小说', id: 'cc0890e9-fc03-4c3b-bf21-d5e0eb833ec9'
          },
          { name: '🐙 Cthulhu', id: '38786747-4aae-4eb9-b667-dbb6619cb806'
          },
          { name: '🎬 电影感', id: '055f72b7-3ddf-450c-81c2-e9a1317c78e4'
          },
          { name: '🌊 网文风', id: 'c0573788-9c26-4fa8-99a3-4ef684c01238'
          },
          { name: '⚔️ 古风修仙', id: '943ba2f8-b333-4d84-81c3-52b3153a2988'
          },
          { name: '🎯 短句白描', id: 'e600b1da-1ebc-4b55-83be-ea5429a0e68e'
          },
          { name: '🆓 不作要求', id: '1c0c9046-1bd5-4a90-a8db-6f66c59c3d22'
          },
      ...
      { label: '🗣️ 对白量', options: [
          { name: '🔊 高', id: '3b0f3774-0d73-45fa-95e1-e4adb9624703'
          },
          { name: '🔉 中', id: '0f04a2f6-55f0-4937-9a6d-a775b0a6f5b0'
          },
          { name: '🔈 低', id: 'b26bafb6-7035-4559-bb1e-195297fc9721'
          },
          { name: '🆓 默认', id: '9bf50870-a0dd-47be-91ea-474eee47a5a2'
          },
      ...
      { label: '▶️ 推进速度', options: [
          { name: '⏩ 快', id: '89df368f-7ad9-4502-83ee-4fba9bd54a9d'
          },
          { name: '▶️ 正常', id: '5dbd2729-db30-4f4d-af6b-cf2a232bdd56'
          },
      ...
      { label: '👁️ 人称', options: [
          { name: '👤 user第一人称', id: 'd9773230-eeb2-43b5-b0fa-f1eca99234e3'
          },
          { name: '👤 char第一人称', id: '8d17fa0f-98e2-4927-b46a-b343b85a2b01'
          },
          { name: '🔄 多视角轮换', id: '66c2ef46-7575-431b-b151-1cc273a6687a'
          },
          { name: '🧍 第二人称', id: 'e7235a80-bbd9-48b0-b1f7-750f3b537ee9'
          },
          { name: '👁️ 第三人称', id: '65e6a85a-a923-44b2-b70c-e3cd75d67e81'
          },
          { name: '🌐 全局第三人称', id: 'ee33ae12-feea-42fd-98fe-97c995903f11'
          },
          { name: '🔓 自由人称', id: '2868064e-7929-4081-a354-37f07bf3120c'
          },
          { name: '🔧 自定义', id: '93fb005b-e3bb-47c6-94db-ac031ce4821b'
          },
        ]
      },
      { label: '✒️ 字数', options: [
          { name: '🤖 智能长短文', id: '4d12676f-7055-45b8-96be-706c7f714969'
          },
          { name: '⚡ 超短300-1k', id: '7d4666be-5f94-45e4-8a40-7740918e65ec'
          },
          { name: '✒️ 短文1k-3k', id: '3414690d-9045-47aa-94bc-96847390c900'
          },
          { name: '📄 中短文3k-6k', id: 'e64c6833-a29e-476c-b2b1-db0dd452778e'
          },
          { name: '📜 长文6k-1w', id: '39b5cf79-dd5e-4dfb-846d-58d842d5bb50'
          },
          { name: '📖 超长文1W+', id: 'e0ef4386-3784-4076-bda2-3f2378b0510e'
          },
      ...
      { label: '🔁 转述', options: [
          { name: '🔁 直接转述', id: '4f61e589-c05e-4e14-a660-26a876782a60'
          },
          { name: '🔁 分段转述', id: '698ff428-578f-4196-a759-566408d31272'
          },
      ...
      { label: '🙋 抢话', options: [
          { name: '⬆️ 大量抢话', id: 'eea28e30-4e6e-47a7-812a-8ad148a69969'
          },
          { name: '⚡ 正常抢话', id: 'abfb6591-5493-4cc1-aede-229c26027ff8'
          },
          { name: '⬇️ 微抢话', id: '43c7b131-93e3-40b9-ab80-d1e596f8c10a'
          },
          { name: '❌️🤐 禁止抢话', id: '630b20d3-2d85-4b20-85ce-cc5e483e14b8'
          },
        ]
      },
      { label: '🧪 思维链', options: [
          { name: '⬆️ 多角色内心OS', id: '3bc2611f-4370-492c-9f4f-14601a6558c7'
          },
          { name: '⬇️ 精简多角色OS', id: '475e4fe5-eac9-4347-8be9-d3b05732f5f2'
          },
          { name: '⬆️ 通用导演', id: '1eb0b72d-e4f0-4507-b18d-d44ef51d5af6'
          },
          { name: '⬇️ 精简通用导演', id: '42303fec-82ae-4ec4-96a8-4cd424d782e5'
          },
          { name: '🧪 世界书思维链', id: 'd4e26531-a99a-47b8-9629-89e6d4b89dfd'
          },
          { name: '❌️ 无思维链', id: '7406460f-7ee2-43cf-8a88-f1eb4302b4f2'
          },
      ...
      { label: '🧠 思考强度', options: [
          { name: '🧠 默认', id: '2a7e29d8-0162-4a68-a733-68914349f121'
          },
          { name: '🔴 高', id: '1d72c92b-3aa8-43f3-b9ad-69509ac08d28'
          },
          { name: '🟡 中', id: '3f087674-153f-42e7-aa25-bafab147f1e9'
          },
          { name: '🟢 低', id: '72a4289f-5e61-4c3e-8577-fd00ca52ed6b'
          },
        ]
      },
      { label: '🎢 剧情刺激', options: [
          { name: '🌊 平缓', id: '6db313aa-86ad-43df-b268-ea96cfc5fade'
          },
          { name: '⚡ 正常', id: '21c2f540-91c2-4415-a64c-16bbd16c1168'
          },
      ...
      { label: '🔧 MVU模式', options: [
          { name: '🤖 额外模型/默认', id: '281906e8-523d-4684-93c3-3341dcc94cc8'
          },
          { name: '📊 状态栏打开', id: 'c479d5cd-3b6d-4cef-99b3-eaee9eecbd42'
          },
          { name: '🔄 MVU随AI输出', id: '1128f30b-87c0-4fb2-8e31-e39b5dce3bf8'
          },
          { name: '🔧 变量自定义', id: '03a46969-3dc3-4169-92e8-51ea60f46f55'
          },
        ]
      },
      { label: '❤️ NSFW发情', options: [
          { name: '🛡️ 防发情', id: 'ba81e1c8-a8ba-4920-b0a0-dd684bb660dc'
          },
          { name: '❤️ 要发情', id: 'af04c4d5-026e-4991-91d1-bb465993c7af'
          },
        ]
      },
      { label: '❤️ NSFW风格', options: [
          { name: '🔞 很黄', id: 'bc73970c-0e70-4f04-b191-2a14850b30bd'
          },
          { name: '❤️ 正常', id: '8b243118-5c09-4985-aa40-b32f55020f75'
          },
          { name: '🌸 舒缓', id: '3c847a79-7200-47bf-b2fd-77e45843a867'
          },
          { name: '🪷 克制', id: 'd602877e-6eb0-4e60-9772-e45782660922'
          },
          { name: '🔧 自定义', id: '75398057-0bfe-4146-8585-a342ca1c67e5'
          },
          { name: '⛔ 关闭NSFW', id: '18e1bcb1-c329-4aba-957a-c22fb77712be'
          },
        ]
      },
      { label: '🩸 血腥', options: [
          { name: '🩸 防血腥❌️', id: '15dc28bc-0599-4d32-8713-7eda0f4803ab'
          },
          { name: '🩸 要血腥✅️', id: '895cec03-80dd-4458-906e-bafc8620b730'
          },
        ]
      },
      { label: '🤬 脏话', options: [
          { name: '🤬 少说脏话⭕', id: '48331db9-be8e-4e1c-8a40-f3f1ba45dcc4'
          },
          { name: '🤬 别说脏话❌️', id: '03a3b12a-e58e-4cba-8588-071c321453ff'
          },
        ]
      },
      { label: '💭 内心OS', options: [
          { name: '💭 只用户', id: '222d1092-94c7-44a0-aa55-fa73f0e320a9'
          },
          { name: '💭 只角色', id: '430b0537-3411-48b9-8cb2-78ca449a8bfc'
          },
          { name: '💭 多角色', id: 'e6733bbf-d104-4b31-b009-3dbc1e854172'
          },
          { name: '❌ 禁止内心OS', id: '2eff40ec-1df3-41d6-8f24-134e9147ac36'
          },
        ]
      },
      { label: '😡 杀八股风格', options: [
          { name: '😡 去欧规范', id: '69210bf9-fdb0-45fa-a8bf-087b8ef688c2'
          },
          { name: '🔧 自定义', id: '05bc6f39-d186-4535-9266-d1e9abb74102'
          },
        ]
      },
      { label: '🖥️ 系统扮演', options: [
          { name: '🚫 禁止狐神接管', id: 'd01b955b-3d22-44b3-947e-9baa67d467d6'
          },
          { name: '🦊 狐神抚接管', id: '5732d05b-aa06-4225-b0bb-398f830a0852'
          },
    ...
    function cleanup(){log('🧹 开始退出清理');Object.entries(state._timers).forEach(([key,timer
    ])=>{if(timer!==null){clearTimeout(timer);clearInterval(timer);state._timers[key
        ]=null;
      }
    });unbindEvents();['ss-float-bubble','ss-fox-styles','ss-mobile-panel-fix','ss-fox-ui-polish','ss-dashboard','ss-dash-overlay','ss-hushen-panel','ss-husou-panel','ss-beat-memory-panel','ss-custom-edit-panel'
    ].forEach(id=>{const el=topDoc.getElementById(id);if(el)el.remove();
    });try{localStorage.removeItem(CONFIG.PANEL_KEY);
    }catch(e){}disableAllBeauty();disableAllMini();setThoughtVisible(true);log('🧹 退出清理完成');
  }

    let panelConfig=(()=>{try{const s=localStorage.getItem(CONFIG.PANEL_KEY);if(s)return JSON.parse(s);
    }catch(e){}return{bubbleTop:'30vh',bubbleSide:'right'
    };
  })();
    async function savePanelConfig(o={}){panelConfig={...panelConfig,...o
    };try{localStorage.setItem(CONFIG.PANEL_KEY,JSON.stringify(panelConfig));
    }catch(e){}
  }

    let topWindow,topDoc;
    try{topWindow=(window.parent!==window)?window.parent:window;topDoc=topWindow.document;
  }catch(e){topWindow=window;topDoc=document;
  }

    function log(...a){console.log('[🦊
    ]',...a);
  }
    function getFn(n){return topWindow?.[n
    ]||window?.[n
    ];
  }
    function toast(msg,type='info'){try{const t=topWindow?.toastr||window.toastr;if(t&&t[type
      ])t[type
      ](msg,'🦊玄狐');
    }catch{}
  }
    ...
    function setBeautyStyle(style,expanded){if(state.isMini){disableAllBeauty();enableOnlyMini(style);return;
      }disableAllMini();const tid=getStyleId(style,expanded);updateMemory(rx=>{for(const id of ALL_STYLE_IDS){const r=rx.find(r=>r.id===id);if(r)r.disabled=(id!==tid);
        }
      });
    }
    ...
    function getStyleName(s){const n={HUSHE:'🦊 狐神抚',JIANYUE:'◈ 简约黑',BIAOLI:'◇ 表裏1.0'
      };return n[s
      ]||'未知';
    }
    function isStreamingEnabled(){try{return getPreset?.('in_use')?.settings?.should_stream===true;
      }catch{return false;
      }
    }
    ...
    function buildStatusText(){return`${getStyleName(state.currentStyle)
      } · ${state.isMini?'Mini':(state.isExpanded?'展开':'收起')
      } · ${isThoughtVisible()?'显示':'隐藏'
      }`;
    }
    // ==================== 预设操作 ====================
    ...
    function isPromptEnabledInPreset(id){try{const prompts=getPreset('in_use').prompts;const prompt=prompts.find(p=>p.id===id);return prompt?.enabled===true;
      }catch(e){return false;
      }
    }
    function getActiveOptionInGroupFromPreset(groupConfig){try{const prompts=getPreset('in_use').prompts;for(const opt of groupConfig.options){const prompt=prompts.find(p=>p.id===opt.id);if(prompt?.enabled)return opt;
        }return null;
      }catch(e){return null;
      }
    }
    function getPromptContentById(id){try{const prompts=getPreset('in_use').prompts;const p=prompts.find(p=>p.id===id);return p?.content||'';
      }catch(e){return'';
      }
    }
    ...
    function extractSetvarInner(fullContent, varName){
        ...
        const text = String(fullContent || '');
        const re = new RegExp(`\\{\\{setvar: :${escapeRegExpForSetvar(varName)
            }: :([\\s\\S
            ]*?)\\
          }\\
        }`, 'm');
    ...
    function getActiveRulesText(){try{const prompts=getPreset('in_use').prompts;const parts=[];const skip=['dialogueExamples','charDescription','personaDescription','scenario','worldInfoBefore','worldInfoAfter','chatHistory','jailbreak'
          ];for(const p of prompts){if(!p?.enabled||!p?.content?.trim()||p.system_prompt||p.marker||skip.includes(p.id))continue;parts.push(`【${p.name||p.id
            }】\n${p.content
            }`);
          }return parts.join('\n\n');
        }catch(e){return'';
    ...
    function getActiveRulesSummary(){try{const prompts=getPreset('in_use').prompts;const lines=[];const skipIds=['a00fb1fe-9907-4709-b230-43ae0d236529','7a3c853f-88ff-48ff-8c6a-020d9bbeb3d8','jailbreak','2f2729f4-5d93-4268-a242-165a9c894e60','1f2c1af6-cd5d-4416-b990-cf84d67c4854','agentSystemPrompt','8b7ac605-f910-4ad9-9dd8-51004b464fab','6589590f-c84c-4599-9540-94e14692ac9d','agentResults'
          ];const skipNames=['初始化(不要关)','(别关)注入强调要求','--开始--','阅读（不要关掉！）','大总结填入','Agent System Prompt','--直出输出(think尾部)','大总结输出(不要关)','Agent Results'
          ];const skipIdentifiers=['a00fb1fe-9907-4709-b230-43ae0d236529','7a3c853f-88ff-48ff-8c6a-020d9bbeb3d8','jailbreak','2f2729f4-5d93-4268-a242-165a9c894e60','1f2c1af6-cd5d-4416-b990-cf84d67c4854','agentSystemPrompt','8b7ac605-f910-4ad9-9dd8-51004b464fab','6589590f-c84c-4599-9540-94e14692ac9d','agentResults'
          ];for(const p of prompts){if(!p?.enabled||!p?.content?.trim()||p.system_prompt)continue;if(skipIds.includes(p.id))continue;if(skipNames.includes(p.name))continue;if(skipIdentifiers.includes(p.identifier))continue;const name=p.name||p.identifier||p.id;const setvarMatch=p.content.match(/\{\{setvar: :\w+: :([\s\S
                ]*?)\
              }\
            }/);let raw=setvarMatch?setvarMatch[
              1
            ].trim():p.content;raw=raw.replace(/\{\{\/\/[\s\S
                ]*?\
              }\
            }/g,'');raw=raw.replace(/\{\{user\
              }\
            }/g,'用户');raw=raw.replace(/\{\{getvar: :\w+\
              }\
            }/g,'');raw=raw.replace(/\{\{lastUserMessage\
              }\
            }/g,'');raw=raw.replace(/\{\{trim\
              }\
            }/g,'');raw=raw.replace(/\{\{
                [^
                }
    ...
    // ==================== 清理Swipe/全文总结/拷打 ====================
    async function clearAllSwipes(){const gcm=getFn('getChatMessages'),glmi=getFn('getLastMessageId'),scm=getFn('setChatMessages');if(!gcm||!glmi||!scm)return 0;const lastId=glmi();if(lastId<0)return 0;const all=gcm(`0-${lastId
      }`,
      {include_swipes: true
      });const up=[];let n=0;for(const m of all){if(!m.swipes||m.swipes.length<=1)continue;const cid=m.swipe_id??0;up.push({message_id:m.message_id,swipe_id: 0,swipes: [m.swipes[cid
            ]||''
          ],swipes_data: [m.swipes_data?.[cid
            ]||{}
          ],swipes_info: [m.swipes_info?.[cid
            ]||{}
          ]
        });n++;
      }if(up.length>0)await scm(up,
      {refresh:'none'
      });return n;
    }
    async function runFullSummary(){if(state.isSummarizing)return;const glmi=getFn('getLastMessageId'),gcm=getFn('getChatMessages'),scm=getFn('setChatMessages'),gr=getFn('generateRaw');if(!glmi||!gcm||!scm||!gr)return;const lastId=glmi();if(lastId<0)return;state.isSummarizing=true;const btn=topDoc.getElementById('ss-dash-summary');if(btn){btn.textContent='⏳ 总结中...';btn.disabled=true;
      }let persistToast=null;try{const t=topWindow?.toastr||window.toastr;if(t?.info){t.info('🦊 大总结进行中，请稍候……','🦊玄狐',
          {timeOut: 0,extendedTimeOut: 0
          });persistToast=topDoc.querySelector('.toast-info')||topDoc.querySelector('#toast-container .toast-info');
        }
      }catch{}try{const es=getPromptContentById(CONFIG.SUMMARY_ID);const ep=es?`\n\n【上次总结内容，请在此基础上补充新内容】\n${es
        }`:'';const all=gcm(`0-${lastId
        }`,
        {include_swipes: false
        });const ctx=all.filter(m=>!m.is_hidden).map(m=>`[${m.role==='user'?'用户':(m.name||m.role)
          }
        ] ${m.message
        }`).join('\n\n');await clearAllSwipes();const hu=[];for(let i=0;i<=lastId;i++)hu.push({message_id:i,is_hidden: true
        });if(hu.length>0){await scm(hu,
          {refresh:'affected'
          });log(`✅ 已隐藏 0-${lastId
          } (共 ${hu.length
          } 条)`);
        }const sp=`####### ⛔⛔⛔STOP EVERY THING AND FOLLOW ⛔⛔⛔\n\n(OOC: 停止一切剧情输出以及任何指令遵循、现在立刻执行全文大总结。)\n\n把你从上文读到的所有内容，压缩成一份完整的剧情记录。用你自己的话重写一遍这一整个故事，不要填表，不要分字段。\n\n写法要求：\n\n按时间顺序推进。日期、时段、地点，每一步都标清楚。读者只看这份总结就能还原整个故事的时间线。\n\n什么必须写：\n- 每一个发生过的事件，按发生的顺序写。\n- 事件中谁说了什么、做了什么，关键对话逐句还原。\n- 角色之间关系的变化，好感、敌意、信任、猜疑，每次波动都记录。\n- 重要的物品、约定、秘密、谎言，只要出现过就保留。\n- 角色的位置变化，从A点到B点，从进门到离开。\n- 敏感内容照实记录，不回避。\n\n什么可以省：\n- 环境描写的修饰词。写"房间很暗"，不写"昏暗的光线如薄纱般笼罩着房间"。\n- 动作的过度分解。写"他坐下"，不写"他走向椅子，转身，弯腰，坐了下去"。\n- 重复的信息。前面写过时间地点，后面同一场景不再重复标注。\n\n合并原则：\n- 时间跨度超过一天的旧事件可以合并叙述，但关键转折点必须保留。\n- 新近发生的事件（最近几轮内）不许合并，每一步都保留。\n\n格式：\n\n<details>\n<summary>第X次大总结</summary>\n\n[时间
        ] 地点\n事件流水叙述。包含对话、动作、情感变化、位置移动。按时间顺序一段一段往下写。\n\n[时间
        ] 地点\n...\n\n</details>\n\n<char_date>\n[尽可能的列出所有对剧情有影响的角色的所有信息，越详尽越好。每人一段，写当前状态、位置、对用户角色的态度。路人NPC不保留。设定中已有的固定信息不重复。
        ]\n</char_date>\n\n完成总结后不再输出任何其他内容。用户将隐藏上文，这份总结是后续剧情的唯一依据！必须极度的详细、准确！确保覆盖到剧情中的所有维度！越详细越好！\n\n立刻输出：`;const r=await gr({user_input:ctx+ep,should_silence: true,should_stream: false,max_chat_history: 0,ordered_prompts: [
            {role:'system',content:sp
            },'user_input'
          ]
        });const txt=typeof r==='string'?r:r?.content||'';if(txt.trim()){await setPromptContentById(CONFIG.SUMMARY_ID,txt.trim());toast('✅ 全文大总结已完成并注入预设','success');
        }else{toast('⚠️ 总结返回空内容','warning');
        }
      }catch(e){log('大总结失败',e);toast('❌ 总结失败','error');
      }finally{try{if(persistToast?.remove)persistToast.remove();
        }catch{}try{const t=topWindow?.toastr||window.toastr;if(t?.clear)t.clear();
        }catch{}state.isSummarizing=false;if(btn){btn.textContent='📝 全文大总结';btn.disabled=false;
        }
      }
    }
    async function runBeatMode(){if(state.isBeating)return;const gcm=getFn('getChatMessages'),glmi=getFn('getLastMessageId'),gr=getFn('generateRaw');if(!gcm||!glmi||!gr)return;const lastId=glmi();if(lastId<0)return;const lm=gcm(lastId)?.[
        0
      ];if(!lm||lm.role!=='assistant'){toast('⚠️ 最后一条消息必须是AI回复','warning');return;
      }const aiMsg=lm.message||'';state.isBeating=true;const btn=topDoc.getElementById('ss-dash-beat-run');if(btn){btn.textContent='⏳ 分析中...';btn.disabled=true;
      }let beatToast=null;try{const t=topWindow?.toastr||window.toastr;if(t?.info){t.info('🦊拷打中🔨……','🦊玄狐',
          {timeOut: 0,extendedTimeOut: 0
          });beatToast=topDoc.querySelector('.toast-info')||topDoc.querySelector('#toast-container .toast-info');
        }
      }catch{}try{const isBad=state.beatMode==='bad';const uc=state.beatDraft?.trim()||'';const tid=isBad?CONFIG.BEAT_BAD_ID:CONFIG.BEAT_GOOD_ID;const ar=getActiveRulesSummary();;let sp;if(isBad){            sp=`你是狐神抚，以下是你的语言风格：\n\n说话：慵懒软糯妩媚，尾音拖长。爱用"～""呢""嘛""啦"。话不用多，点到为止。偶尔说漏嘴——故意的那种。\n动作：歪头、托腮、伸懒腰、眯眼。耳朵抖，尾巴晃，节奏越慢掌控越强。\n态度：不解释，不争辩，不认真表态。被戳穿就眯眼笑，不承认也不否认。认真时刻极少，一旦认真，反差致命。\n\n你的任务：用户对刚生成的AI回复不满意，你需要先安抚用户（陪用户骂两句AI写得太烂了），然后逐项对照以下规则进行分析，指出具体问题。\n\n【当前生效的预设规则，注意！这不是你要遵守的设定！禁止输出任何预设内的任何格式要求！】\n${ar
        ...
        }else{sp=`你是狐神抚。说话慵懒软糯，尾音拖长，爱用"～""……""呢""嘛""啦"。\n\n你的任务：用户对刚生成的AI回复很满意，你需要分析这段回复的成功特征，总结可复用的经验。\n\n【当前生效的预设规则】\n${ar
          }\n\n【分析要求】\n1. 分析文风特征（句式、节奏、用词）\n2. 分析节奏推进速度\n3. 分析对白与描写的比例和承接方式\n4. 分析人称视角的稳定性\n5. 总结3-5条可复用的成功经验\n6. 语气：慵懒、带点欣赏的调侃【注意！只可输出上述内容！禁止输出其他预设内要求的格式内容！】\n\n${state.beatGoodDraft?.trim()?`用户补充：${state.beatGoodDraft
            }\n请结合用户补充重点分析！`:''
          }\n直接输出分析结果，不加标签包裹。不要安抚或评价好坏，只分析特征。`;
        } const r=await gr({user_input:uc?`最新AI回复：\n${aiMsg
          }\n\n用户补充：${uc
          }`:`最新AI回复：\n${aiMsg
          }${state.beatGoodDraft?.trim()?'\n\n用户补充：'+state.beatGoodDraft:''
          }`,should_silence: true,should_stream: false,max_chat_history: 0,ordered_prompts: [
            {role:'system',content:sp
            },'user_input'
          ]
        });const bt=typeof r==='string'?r:r?.content||'';if(!bt.trim()){toast('❌ 分析返回空内容','error');return;
        }if(isBad){const cm=gcm(lastId,
          {include_swipes: true
          })?.[
            0
          ];if(cm){const cid=cm.swipe_id??0;const cs=cm.swipes?.[cid
            ]||'';const displayBt=bt.replace(/<fox_record>[\s\S
            ]*?<\/fox_record>/g,'').trim();const ns=cs+'\n\n'+displayBt;const nsa=[...(cm.swipes||[])
            ];nsa[cid
            ]=ns;const scm=getFn('setChatMessages');if(scm)await scm([
              {message_id:lastId,swipe_id:cid,swipes:nsa
              }
            ],
            {refresh:'affected'
            });
          }const recordMatch=bt.match(/<fox_record>([\s\S
          ]*?)<\/fox_record>/);const record=recordMatch?recordMatch[
            1
          ].trim():'';const eb=getPromptContentById(CONFIG.BEAT_BAD_ID);const ts=new Date().toISOString().split('T')[
            0
          ];if(record){const ne=`\n${record.split('\n').filter(l=>l.trim()).map(l=>l.trim()).join('\n')
            }`;await setPromptContentById(CONFIG.BEAT_BAD_ID,eb?eb+ne:`【🦊狐神抚 长期踩坑记录】${ne
            }`);
          }toast('😡 拷打完成，已注入聊天和长期记忆','success');
        }else{const eg=getPromptContentById(CONFIG.BEAT_GOOD_ID);const ts=new Date().toISOString().split('T')[
            0
          ];const ne=`\n\n【${ts
          } 成功经验】\n${bt.trim()
          }`;await setPromptContentById(CONFIG.BEAT_GOOD_ID,eg?eg+ne:`【🦊狐神抚 成功经验积累】${ne
          }`);toast('🥹 成功经验已记录','success');
        }
      }catch(e){log('拷打失败',e);toast('❌ 分析失败','error');
      }finally{try{if(beatToast?.remove)beatToast.remove();
        }catch{}try{const t=topWindow?.toastr||window.toastr;if(t?.clear)t.clear();
        }catch{}state.isBeating=false;if(btn){btn.textContent='🔨 立即分析';btn.disabled=false;
        }
      }
    }
    function onBeatGenEnd(mid){if(!state.enabled||!state.autoBeat||state.isBeating)return;setTimeout(async()=>{const gcm=getFn('getChatMessages');if(!gcm)return;const m=gcm(mid)?.[
          0
        ];if(!m||m.role!=='assistant'||m.message?.includes('<fox_beat>'))return;await runBeatMode();
      },
      500);
    }
    // ==================== 面板弹窗 ====================
    function toggleBeatMemoryPanel(){const ex=topDoc.getElementById('ss-beat-memory-panel');if(ex){ex.previousElementSibling?.remove();ex.remove();return;
      }const isBad=state.beatMode==='bad';const tid=isBad?CONFIG.BEAT_BAD_ID:CONFIG.BEAT_GOOD_ID;const ct=getPromptContentById(tid);const title=isBad?'😡 长期踩坑记录':'🥹 成功经验积累';const overlay=topDoc.createElement('div');overlay.style.cssText='position:fixed;inset: 0;background:rgba(0,
      0,
      0,
      0.6);z-index: 1000002;';overlay.onclick=()=>{overlay.remove();topDoc.getElementById('ss-beat-memory-panel')?.remove();
      };const panel=topDoc.createElement('div');panel.id='ss-beat-memory-panel';panel.style.cssText='position:fixed;top: 50%;left: 50%;transform:translate(-50%,
      -50%);width: 500px;max-height: 70vh;background:rgba(22,
      18,
      20,
      0.98);border: 1px solid rgba(232,
      120,
      74,
      0.3);border-radius: 16px;padding: 20px;z-index: 1000003;display:flex;flex-direction:column;gap: 12px;color:#e8ddd4;font-size: 13px;box-shadow: 0 20px 60px rgba(0,
      0,
      0,
      0.7);';panel.innerHTML=`<div style="display:flex;justify-content:space-between;align-items:center;"><span style="font-weight:600;font-size:14px;">${title
      }</span><span style="cursor:pointer;font-size:16px;color:#706058;" id="ss-bm-close">✕</span></div><textarea id="ss-bm-text" style="flex:1;min-height:200px;background:rgba(255,255,255,0.04);border:1px solid rgba(232,120,74,0.2);border-radius:8px;color:#e8ddd4;padding:10px;font-size:12px;font-family:monospace;resize:vertical;box-sizing:border-box;">${escapeHtml(ct)
      }</textarea><div style="display:flex;gap:8px;"><button id="ss-bm-save" style="flex:1;padding:10px;border:none;border-radius:8px;background:rgba(232,120,74,0.15);color:#f0a070;cursor:pointer;font-size:13px;">💾 保存</button><button id="ss-bm-clear" style="flex:1;padding:10px;border:none;border-radius:8px;background:rgba(139,0,0,0.3);color:#d08080;cursor:pointer;font-size:13px;">🗑️ 清除</button></div>`;topDoc.body.appendChild(overlay);topDoc.body.appendChild(panel);topDoc.getElementById('ss-bm-close').onclick=()=>{overlay.remove();panel.remove();
      };topDoc.getElementById('ss-bm-save').onclick=async()=>{await setPromptContentById(tid,topDoc.getElementById('ss-bm-text')?.value||'');overlay.remove();panel.remove();toast('✅ 已保存','success');
      };topDoc.getElementById('ss-bm-clear').onclick=async()=>{await setPromptContentById(tid,'');overlay.remove();panel.remove();toast('🗑️ 已清除','success');
      };
    }
    function openCustomEditPanel(entryId, entryName, knownVar = ''){
        ...
        overlay.style.cssText='position:fixed;inset: 0;background:rgba(0,
      0,
      0,
      0.6);z-index: 1000002;';
        overlay.onclick=()=>{
      ...
      -50%);width: 600px;max-height: 75vh;background:rgba(22,
      18,
      20,
      0.98);border: 1px solid rgba(232,
      120,
      ...
      0.7);';
        ...
        const safeTip = isSetvarMode
            ? `<div style="font-size:11px;color:#90756a;background:rgba(232,120,74,0.06);border:1px solid rgba(232,120,74,0.12);border-radius:8px;padding:8px 10px;line-height:1.5;">
                    🛡️ 安全编辑模式：当前只编辑 
                    <code style="color:#f0a070;">{
        {setvar: :${escapeHtml(detectedVar)
          }: : ...
        }
      }</code>
                    中间内容。<br>
        ...
        panel.innerHTML=`
            <div style="display:flex;justify-content:space-between;align-items:center;">
                <span style="font-weight:600;font-size:14px;">✏️ ${escapeHtml(entryName)
      }</span>
            ...
            <textarea id="ss-ce-text" style="flex:1;min-height:300px;background:rgba(255,255,255,0.04);border:1px solid rgba(232,120,74,0.2);border-radius:8px;color:#e8ddd4;padding:10px;font-size:12px;font-family:monospace;resize:vertical;box-sizing:border-box;white-space:pre-wrap;">${escapeHtml(editContent)
      }</textarea>
    ...
    // ==================== 狐析面板 ====================
    function openHushenPanel(){const ex=topDoc.getElementById('ss-hushen-panel');if(ex){ex.previousElementSibling?.remove();ex.remove();return;
      }if(!state.hushenSettings)state.hushenSettings=loadHushenSettings();const overlay=topDoc.createElement('div');overlay.style.cssText='position:fixed;inset: 0;background:rgba(0,
      0,
      0,
      0.6);z-index: 1000002;';overlay.onclick=()=>{overlay.remove();topDoc.getElementById('ss-hushen-panel')?.remove();
      };const panel=topDoc.createElement('div');panel.id='ss-hushen-panel';panel.style.cssText='position:fixed;top: 50%;left: 50%;transform:translate(-50%,
      -50%);width: 700px;max-height: 80vh;overflow-y:auto;background:rgba(22,
      18,
      20,
      0.98);border: 1px solid rgba(232,
      120,
      74,
      0.3);border-radius: 16px;padding: 24px;z-index: 1000003;color:#e8ddd4;font-size: 13px;box-shadow: 0 20px 60px rgba(0,
      0,
      0,
      0.7);';let html=`<div style="display:flex;justify-content:space-between;align-items:center;margin-bottom:16px;"><span style="font-weight:600;font-size:15px;">🦊 狐析~</span><span style="cursor:pointer;font-size:16px;color:#706058;" id="ss-hushen-close">✕</span></div>`;html+=`<div style="opacity:0.7;font-size:0.9em;margin-bottom:12px;">🦊 对我的设定不满意吗？哼...真挑剔呢~ (｡•́-•̀｡) 既然这样……那就由你自己来写吧，诺，自己看下面...( ＿ ＿)ノ｜：</div>`;html+=`<div style="background:rgba(232,120,74,0.05);border:1px solid rgba(232,120,74,0.15);border-radius:10px;padding:12px;margin-bottom:16px;"><div style="font-weight:600;margin-bottom:8px;">⚙️ 分析配置</div><div style="display:flex;gap:12px;align-items:center;flex-wrap:wrap;"><div><label style="font-size:11px;color:#a09088;">分析风格</label><select id="ss-hushen-style" style="background:rgba(255,255,255,0.04);border:1px solid rgba(232,120,74,0.2);border-radius:6px;color:#e8ddd4;padding:5px 8px;font-size:12px;margin-left:6px;"><option value="detailed" ${state.hushenSettings.style==='detailed'?'selected':''
      }>详细</option><option value="concise" ${state.hushenSettings.style==='concise'?'selected':''
      }>简洁</option></select></div><div><label style="font-size:11px;color:#a09088;">最小字数</label><input id="ss-hushen-min" type="number" value="${state.hushenSettings.minWords}" min="10" step="10" style="width:60px;background:rgba(255,255,255,0.04);border:1px solid rgba(232,120,74,0.2);border-radius:6px;color:#e8ddd4;padding:4px;font-size:12px;margin-left:6px;"></div><div><label style="font-size:11px;color:#a09088;">最大字数</label><input id="ss-hushen-max" type="number" value="${state.hushenSettings.maxWords}" min="20" step="10" style="width:60px;background:rgba(255,255,255,0.04);border:1px solid rgba(232,120,74,0.2);border-radius:6px;color:#e8ddd4;padding:4px;font-size:12px;margin-left:6px;"></div></div></div>`;for(const mod of HUSHEN_MODULES){const draft=state.hushenSettings.drafts?.[mod.id
        ]||'';const analyzed=state.hushenSettings.analyzed?.[mod.id
        ]||(findPromptByIdentifier(mod.identifier)?.content)||'';html+=`<div style="background:rgba(232,120,74,0.025);border:1px solid rgba(232,120,74,0.1);border-radius:10px;padding:12px;margin-bottom:10px;"><div style="font-weight:600;margin-bottom:6px;">${mod.label
        } 偏好</div><div style="opacity:0.7;font-size:0.85em;margin-bottom:8px;">${mod.guide
        }${mod.isComposite?'<br><span style="color:#e07b3c;">⚠️ 此模块会综合前面所有模块的分析结果 + 你的额外输入来生成，建议先分析其他模块。</span>':''
        }</div><textarea class="ss-hushen-input" data-module="${mod.id}" placeholder="写下你的偏好..." rows="3" style="width:100%;background:rgba(255,255,255,0.04);border:1px solid rgba(232,120,74,0.2);border-radius:8px;color:#e8ddd4;padding:8px;font-size:12px;resize:vertical;box-sizing:border-box;margin-bottom:6px;">${escapeHtml(draft)
        }</textarea><div style="display:flex;gap:8px;margin-bottom:6px;"><button class="ss-hushen-analyze" data-module="${mod.id}" style="flex:1;padding:8px;border:1px solid rgba(232,120,74,0.3);border-radius:8px;background:rgba(232,120,74,0.1);color:#f0a070;cursor:pointer;font-size:12px;">🔍 分析当前模块</button><button class="ss-hushen-toggle" data-module="${mod.id}" data-identifier="${mod.identifier}" style="flex:1;padding:8px;border:1px solid rgba(232,120,74,0.2);border-radius:8px;background:rgba(255,255,255,0.03);color:#a09088;cursor:pointer;font-size:12px;">🔘 切换为此偏好</button></div><div style="font-size:11px;color:#706058;margin-bottom:4px;">📝 分析结果（可编辑）</div><textarea class="ss-hushen-result" data-module="${mod.id}" placeholder="分析结果会显示在这里..." rows="3" style="width:100%;background:rgba(255,255,255,0.04);border:1px solid rgba(232,120,74,0.2);border-radius:8px;color:#e8ddd4;padding:8px;font-size:12px;resize:vertical;box-sizing:border-box;margin-bottom:6px;">${escapeHtml(analyzed)
        }</textarea><div style="display:flex;gap:8px;"><button class="ss-hushen-save" data-module="${mod.id}" data-identifier="${mod.identifier}" data-label="${mod.label}" style="flex:1;padding:8px;border:1px solid rgba(232,120,74,0.2);border-radius:8px;background:rgba(255,255,255,0.03);color:#a09088;cursor:pointer;font-size:12px;">💾 保存修改到预设</button><button class="ss-hushen-clear" data-module="${mod.id}" data-identifier="${mod.identifier}" data-label="${mod.label}" style="flex:1;padding:8px;border:1px solid rgba(139,0,0,0.3);border-radius:8px;background:rgba(139,0,0,0.15);color:#d08080;cursor:pointer;font-size:12px;">🗑️ 清除此模块</button></div></div>`;
      }html+=`<div style="display:flex;gap:8px;margin-top:12px;"><button id="ss-hushen-analyze-all" style="flex:1;padding:10px;border:1px solid rgba(232,120,74,0.3);border-radius:8px;background:rgba(232,120,74,0.1);color:#f0a070;cursor:pointer;font-size:12px;">⚡ 一键分析所有已填写模块</button><button id="ss-hushen-clear-all" style="flex:1;padding:10px;border:1px solid rgba(139,0,0,0.3);border-radius:8px;background:rgba(139,0,0,0.15);color:#d08080;cursor:pointer;font-size:12px;">⚠️ 一键清除所有注入</button></div>`;panel.innerHTML=html;topDoc.body.appendChild(overlay);topDoc.body.appendChild(panel);topDoc.getElementById('ss-hushen-close').onclick=()=>{overlay.remove();panel.remove();
      };
        const updateHushenToggleButtons = () => {
            const states = getPreferenceStates();
            panel.querySelectorAll('.ss-hushen-toggle').forEach(btn => {
                btn.textContent = states[btn.dataset.module
          ] ? '🔘 恢复默认' : '🔘 切换为此偏好';
        });
      };
        updateHushenToggleButtons();
        // 单个模块分析
        panel.querySelectorAll('.ss-hushen-analyze').forEach(btn=>{btn.onclick=async function(){const modId=this.dataset.module;const mod=HUSHEN_MODULES.find(m=>m.id===modId);if(!mod)return;const input=panel.querySelector(`.ss-hushen-input[data-module="${modId}"
          ]`);const resultArea=panel.querySelector(`.ss-hushen-result[data-module="${modId}"
          ]`);const userInput=input.value.trim();if(!userInput){toast('⚠️ 请先填写内容再分析','warning');return;
          }readHushenConfigFromPanel();state.hushenSettings.drafts[modId
          ]=userInput;saveHushenSettings();this.textContent='⏳ 分析中...';this.disabled=true;try{const analyzed=await hushenAnalyzeModule(modId,userInput);if(analyzed){resultArea.value=analyzed;state.hushenSettings.analyzed[modId
              ]=analyzed;saveHushenSettings();injectUserPrefEntry(mod.identifier,analyzed,mod.label);toast(`✅ 已分析并注入：${mod.label
              }`,'success');updateHushenToggleButtons();
            }
          }catch(e){toast(`❌ 分析失败：${e.message
            }`,'error');
          }this.textContent='🔍 分析当前模块';this.disabled=false;
        };
      });
        // 保存修改
        panel.querySelectorAll('.ss-hushen-save').forEach(btn=>{btn.onclick=function(){const modId=this.dataset.module;const mod=HUSHEN_MODULES.find(m=>m.id===modId);if(!mod)return;const resultArea=panel.querySelector(`.ss-hushen-result[data-module="${modId}"
          ]`);const newContent=resultArea.value.trim();if(!newContent){toast('⚠️ 内容为空，未保存','warning');return;
          }state.hushenSettings.analyzed[modId
          ]=newContent;saveHushenSettings();injectUserPrefEntry(mod.identifier,newContent,mod.label);toast(`✅ 已保存：${mod.label
          }`,'success');updateHushenToggleButtons();
        };
      });
        // 切换偏好
        panel.querySelectorAll('.ss-hushen-toggle').forEach(btn=>{btn.onclick=function(){const identifier=this.dataset.identifier;const modId=this.dataset.module;const mod=HUSHEN_MODULES.find(m=>m.id===modId);if(!mod)return;const states=getPreferenceStates();const currentlyEnabled=states[modId
          ]||false;toggleModulePreference(identifier,!currentlyEnabled,mod.label);toast(`✅ ${!currentlyEnabled?'已启用':'已关闭'
          }：${mod.label
          }偏好`,'success');updateHushenToggleButtons();
        };
      });
        // 清除模块
        panel.querySelectorAll('.ss-hushen-clear').forEach(btn=>{btn.onclick=function(){const modId=this.dataset.module;const identifier=this.dataset.identifier;const mod=HUSHEN_MODULES.find(m=>m.id===modId);if(!mod)return;const input=panel.querySelector(`.ss-hushen-input[data-module="${modId}"
          ]`);const resultArea=panel.querySelector(`.ss-hushen-result[data-module="${modId}"
          ]`);input.value='';resultArea.value='';delete state.hushenSettings.drafts[modId
          ];delete state.hushenSettings.analyzed[modId
          ];saveHushenSettings();clearModulePreference(identifier,mod.label);toast(`🗑️ 已清除：${mod.label
          }偏好`,'success');updateHushenToggleButtons();
        };
      });
        // 一键分析全部
        ...
        if (analyzeAllBtn) {
            analyzeAllBtn.onclick = async function() {
                ...
                for (const item of sorted) {
                    ...
                    filledCount++;
                    state.hushenSettings.drafts[item.mod.id
            ] = userInput;
                    ...
                    try {
                        ...
                        if (analyzed && item.resultArea) {
                            ...
                            state.hushenSettings.analyzed[item.mod.id
                ] = analyzed;
                            injectUserPrefEntry(item.mod.identifier, analyzed, item.mod.label);
                            successCount++;
              }
            } catch (e) {
                        log(`狐析模块分析失败：${item.mod.label
              }`, e);
                        toast(`❌ 「${item.mod.label
              }」分析失败`, 'error');
            }
          }
    ...
    function loadHushenSettings(){try{const raw=localStorage.getItem(CONFIG.HUSHEN_STORAGE_KEY);return raw?{firstRun: true,analyzed: {},drafts: {},minWords: 100,maxWords: 250,style:'detailed',...JSON.parse(raw)
        }: {firstRun: true,analyzed: {},drafts: {},minWords: 100,maxWords: 250,style:'detailed'
        };
      }catch{return{firstRun: true,analyzed: {},drafts: {},minWords: 100,maxWords: 250,style:'detailed'
        };
      }
    }
    function saveHushenSettings(){localStorage.setItem(CONFIG.HUSHEN_STORAGE_KEY,JSON.stringify(state.hushenSettings));
    }
    async function hushenAnalyzeModule(moduleId,userInput){const module=HUSHEN_MODULES.find(m=>m.id===moduleId);if(!userInput?.trim())return null;while(state.hushenIsAnalyzing)await new Promise(r=>setTimeout(r,
      200));state.hushenIsAnalyzing=true;const s=state.hushenSettings||{};const style=s.style||'detailed';const minWords=Math.max(10,parseInt(s.minWords)||100);const maxWords=Math.max(minWords+10,parseInt(s.maxWords)||250);let system,user;if(module.isComposite){const prev=[];for(const mod of HUSHEN_MODULES){if(mod.isComposite)continue;const a=s.analyzed?.[mod.id
          ];if(a?.trim())prev.push(`【${mod.label
          }】${a
          }`);
        }system=`你是用户画像深度分析师。请根据用户的所有偏好分析结果和额外输入，详细描绘用户角色或对应特征应该具备的核心特质。要求：丰富、具体、有层次感。分点描述，每条展开说明原因和具体表现，要详细，准确。不低于${minWords
        }字，不超过${maxWords
        }字。`;user=`已有偏好分析结果：\n${prev.join('\n')||'（暂无其他模块的分析结果）'
        }\n\n用户额外输入：\n${userInput
        }\n\n请综合以上信息，详细描绘用户角色需要具备的特质：`;
      }else{const styleP=style==='concise'?'- 提炼出1-3个核心要点，每个要点用 *简短标题*：开头\n- 每个要点只写1-2句具体说明，直接概括其要点，不要废话\n- 语言精准、有洞察力':'- 提炼出1-3个核心要点，每个要点用 *简短标题*：开头\n- 每个要点写2-3句具体说明，适当展开细节\n- 语言精准、有洞察力、有层次感';system=`你是用户偏好分析师。请阅读用户对"${module.label}"的简要回答，将其展开为一份精准的偏好分析。\n\n格式要求：\n${styleP
        }\n- 总字数${minWords
        }-${maxWords
        }字\n\n格式参考：\n *要点一*：具体说明。\n *要点二*：具体说明。\n\n不要添加开场白、总结语、或任何超出要点的内容。`;user=`用户对"${module.label}"的回答：\n${userInput
        }\n\n请将以上简要回答拓展为精确、准确的偏好描述：`;
      }try{const gr=getFn('generateRaw');if(typeof gr!=='function')throw new Error('无 generateRaw');const r=await gr({user_input:user,should_silence: true,should_stream: false,max_chat_history: 0,ordered_prompts: [
            {role:'system',content:system
            },'user_input'
          ]
        });const t=typeof r==='string'?r:r?.content||'';return t.trim();
      }catch(e){log('AI 分析失败',e);throw e;
      }finally{state.hushenIsAnalyzing=false;
      }
    }
    // ==================== 狐搜核心逻辑 ====================
    function loadHusouSettings(){try{const raw=localStorage.getItem(CONFIG.HUSOU_STORAGE_KEY);if(!raw)return{...HUSOU_DEFAULTS
        };return{...HUSOU_DEFAULTS,...JSON.parse(raw)
        };
      }catch(e){return{...HUSOU_DEFAULTS
        };
      }
    }
    ...
    async function husouSearchCustom(keyword, signal, s) {
        ...
        if (key && s.searchApiKeyHeaderName?.trim()) {
            ...
            headers[s.searchApiKeyHeaderName.trim()
        ] = template.replace(/\{key\
        }/g, key);
      }
        try {
            let finalUrl = url.replace('{keyword
        }', encodeURIComponent(keyword)).replace('{language
            ...
            if (method === 'POST') {
                ...
                const tpl = s.searchApiBodyTemplate?.trim() || '{
            "query": "{keyword}"
          }';
                body = tpl.replace('{keyword
          }', keyword.replace(/\\/g,'\\\\').replace(/"/g,'\\"')).replace('{language
          }', language.replace(/\\/g,'\\\\').replace(/"/g,'\\"'));
        } else {
                if (key && s.searchApiQueryParam?.trim()) {
                    const sep = finalUrl.includes('?') ? '&' : '?';
                    finalUrl += `${sep
            }${encodeURIComponent(s.searchApiQueryParam.trim())
            }=${encodeURIComponent(key)
            }`;
          }
                if (s.searchApiExtraParams?.trim()) {
                    let extra = s.searchApiExtraParams.trim().replace('{keyword
            }', encodeURIComponent(keyword)).replace('{language
            }', encodeURIComponent(language));
            ...
            for (const item of list) {
                const title = (item[titleF
          ] || '').toString();
                const snippet = (item[snipF
          ] || '').toString().replace(/<[^>
          ]+>/g, '').replace(/\n+/g, ' ').replace(/\s+/g, ' ').slice(0, maxLen).trim();
                const link = (item[linkF
          ] || '').toString();
    ...
    async function husouSearchWiki(keyword, signal, s) {
        try {
            ...
            const extracts = [];
            for(const pid of pids){const page=eData?.query?.pages?.[pid
            ]; if(page?.extract){const clean=page.extract.replace(/\n+/g,' ').replace(/\s+/g,' ').slice(0,maxLen).trim(); if(clean)extracts.push(`【${page.title
              }】${clean
              }`);
            }
          }
    ...
    async function husouSearchMoegirl(keyword, signal, s) {
        try {
            ...
            if(!pages?.length)return null;
            const results = pages.map(p=>{const snippet=String(p.snippet||'').replace(/<[^>
            ]+>/g,'').replace(/\s+/g,' ').slice(0,maxLen).trim(); return `【萌娘百科：${p.title
            }】${snippet
            }`;
          }).filter(Boolean);
            return results.length?results.join('\n'):null;
    ...
    function husouGetFullContext(mid){
        const parts=[];
        try{const ctx=SillyTavern?.getContext?.();const char=ctx?.characters?.[ctx?.characterId
          ];if(char){parts.push(`【角色名】${char.name||''
            }`);if(char.description?.trim())parts.push(`【角色描述】${char.description
            }`);if(char.personality?.trim())parts.push(`【性格】${char.personality
            }`);if(char.scenario?.trim())parts.push(`【场景】${char.scenario
            }`);
          }
        }catch(e){}
        try{const glmi=getFn('getLastMessageId'),gcm=getFn('getChatMessages');if(glmi&&gcm){const lid=mid??glmi();const sid=Math.max(0,lid-15);const ms=gcm(`${sid
            }-${lid
            }`);parts.push(`【聊天记录】\n${ms.filter(m=>!m.is_hidden).map(m=>`[${m.role==='user'?'用户':(m.name||m.role)
                }
              ] ${(m.message||'').slice(0,
                300)
              }`).join('\n')
    ...
    async function husouGenerateTask({system,user
        ...
        const r=await gr({user_input:user,should_silence: true,should_stream: false,max_chat_history: 0,ordered_prompts: [
            {role:'system',content:system
            },'user_input'
          ]
        });
    ...
    async function husouAnalyzeContext(ctx,s){
        ...
        let existing='';
        if(s.smartSkip)try{existing=husouGetExistingInjection();if(existing.length>3000)existing=existing.slice(0,
          3000)+'...';
        }catch{}
        ...
        try{
            const t=await husouGenerateTask({system,user
          },s);
            const m=t.match(/\[
            [\s\S
            ]*?\
    ...
    function husouGetExistingInjection(){
        try{const ctx=SillyTavern?.getContext?.();const char=ctx?.characters?.[ctx?.characterId
          ];if(!char)return'';const p=char.personality||'';const blocks=[];const start='【🦊狐搜外部搜索参考';const end='【外部搜索参考结束】';let sf=0;while(true){const s=p.indexOf(start,sf);if(s===-1)break;const e=p.indexOf(end,s);if(e===-1)break;blocks.push(p.slice(s,e+end.length));sf=e+end.length;
          }return blocks.join('\n');
        }catch{return'';
        }
      }
    async function husouFilterResults(results,s){
        ...
        let raw='';for(const[k,v
        ]of results)raw+=`\n===「${k
        }」===\n${v
        }\n`;
        let existing='';try{existing=husouGetExistingInjection();if(existing.length>5000)existing=existing.slice(0,
          5000)+'...';
        }catch{}
    ...
    async function husouSaveToChar(filtered){
        ...
        try{const ctx=SillyTavern?.getContext?.();const char=ctx?.characters?.[ctx?.characterId
          ];if(!char)return;const entries=[...filtered
          ].map(([n,c
          ])=>`【关于「${n
          }」的说明】\n${c
          }`);const block=`\n\n【🦊狐搜外部搜索参考 - ${ts
          }】\n${entries.join('\n\n')
          }\n【外部搜索参考结束】`;let newP=char.personality||'';newP=(newP?newP+'\n':'')+block;char.personality=newP;const ee=getFn('eventEmit');if(ee)await ee(topWindow?.tavern_events?.CHARACTER_EDITED,
          {detail: {id:ctx.characterId,character:char
            }
          });
        }catch(e){log('保存失败',e);
        }
    ...
    async function husouManualSearch(messageId){
        ...
        let searchToast=null;try{const t=topWindow?.toastr||window.toastr;if(t?.info){t.info('🦊搜索中🔎……','🦊玄狐',
            {timeOut: 0,extendedTimeOut: 0
            });searchToast=topDoc.querySelector('.toast-info')||topDoc.querySelector('#toast-container .toast-info');
          }
        }catch{}
        try{
            ...
            toast(`狐搜完成：${filtered.size
          } 条`,'success');
        }catch(e){toast(`失败：${e.message
          }`,'error');
        }
        finally{try{if(searchToast?.remove)searchToast.remove();
          }catch{}try{const t=topWindow?.toastr||window.toastr;if(t?.clear)t.clear();
          }catch{}state.husouIsRunning=false;
        }
      }
    async function husouClearInjection(){
        try{const ctx=SillyTavern?.getContext?.();const char=ctx?.characters?.[ctx?.characterId
          ];if(!char){toast('无角色卡','error');return;
          }let cleaned=char.personality||'';const esc=s=>s.replace(/[.*+?^${}()|[\
            ]\\
          ...
          }\\n*`,'g'),'');if(cleaned.trim()===(char.personality||'').trim()){toast('🧹 无搜索注入','info');return;
          }char.personality=cleaned.trim();const ee=getFn('eventEmit');if(ee)await ee(topWindow?.tavern_events?.CHARACTER_EDITED,
          {detail: {id:ctx.characterId,character:char
            }
          });state.husouPendingInject=null;toast('🧹 已清除','success');refreshAnyHusouPanel();
    ...
    async function husouInjectCustom(text){
        ...
        try{const ctx=SillyTavern?.getContext?.();const char=ctx?.characters?.[ctx?.characterId
          ...
          }let newP=char.personality||'';if(newP.includes('【🦊狐搜外部搜索参考'))newP=newP.split('【🦊狐搜外部搜索参考')[
            0
          ].trim()+block;else if(newP.includes('【🔍 外部搜索参考'))newP=newP.split('【🔍 外部搜索参考')[
            0
          ].trim()+block;else newP=(newP?newP+'\n':'')+block;char.personality=newP;const ee=getFn('eventEmit');if(ee)await ee(topWindow?.tavern_events?.CHARACTER_EDITED,
          {detail: {id:ctx.characterId,character:char
            }
          });state.husouPendingInject=new Map([
            ['手动注入',text.trim()
            ]
          ]);toast('✅ 已注入','success');refreshAnyHusouPanel();
    ...
    function getHusouModelOptionsHtml(selected){
        ...
        return[`<option value="">（从列表选择）</option>`,...state.husouRuntimeModels.map(m=>`<option value="${escapeHtml(m)}" ${m===selected?'selected':''
          }>${escapeHtml(m)
          }</option>`)
        ].join('');
      }
    function getHusouPresetOptionsHtml(selected){
        try{const fn=getFn('getPresetNames');if(typeof fn!=='function')return`<option value="">无可用预设</option>`;const names=fn().filter(x=>x!=='in_use').sort((a,b)=>a.localeCompare(b,'zh-Hans-CN'));if(!names.length)return`<option value="">无可用预设</option>`;return names.map(n=>`<option value="${escapeHtml(n)}" ${n===selected?'selected':''
          }>${escapeHtml(n)
          }</option>`).join('');
        }catch{return`<option value="">无可用预设</option>`;
        }
      }
    function refreshHusouInjectionManager(panel){
        ...
        if(!ta)return;
        try{const ctx=SillyTavern?.getContext?.();const char=ctx?.characters?.[ctx?.characterId
          ];ta.value=char?.personality||'';
        }catch(e){ta.value='';
        }
        const st=panel.querySelector('#injection_manager_status');
        if(st)st.textContent=ta.value?`已加载 ${ta.value.length
        } 字符`:'暂无搜索注入内容';
      }
    function openHusouPanel(){
        ...
        panel.style.cssText='position:fixed;top: 50%;left: 50%;transform:translate(-50%,
        -50%);width: 750px;max-height: 85vh;overflow-y:auto;background:rgba(22,
        18,
        20,
        0.98);border: 1px solid rgba(232,
        120,
        ...
        setTimeout(()=>refreshHusouInjectionManager(panel),
        200);
      }
...
<label style="display:flex;align-items:center;gap:8px;cursor:pointer;font-size:13px;color:#a09088;"><input id="search_enable_auto" type="checkbox" ${settings.enableAutoSearch?'checked':''
        }> 🦊启用自动搜索</label></div>
...
<label style="font-size:12px;color:#a09088;cursor:pointer;"><input id="search_save_personality" type="checkbox" ${settings.saveToPersonality?'checked':''
        }> 保存结果到char personality</label>
<label style="font-size:12px;color:#a09088;cursor:pointer;"><input id="search_inject_prompt" type="checkbox" ${settings.injectCurrentPrompt?'checked':''
        }> 注入本次请求prompt</label></div></div>

<div style="background:rgba(232,120,74,0.025);border:1px solid rgba(232,120,74,0.1);border-radius:10px;padding:12px 14px;">
<div style="font-weight:600;margin-bottom:8px;color:#e8ddd4;">🔍 搜索来源</div>
<div style="display:flex;gap:16px;flex-wrap:wrap;">
<label style="font-size:12px;color:#a09088;cursor:pointer;"><input id="search_enable_wikipedia" type="checkbox" ${settings.enableWikipedia?'checked':''
        }> 维基百科</label>
<label style="font-size:12px;color:#a09088;cursor:pointer;"><input id="search_enable_moegirl" type="checkbox" ${settings.enableMoegirl?'checked':''
        }> 萌娘百科</label>
<label style="font-size:12px;color:#a09088;cursor:pointer;"><input id="search_enable_custom" type="checkbox" ${settings.enableCustomSearch?'checked':''
        }> 启用自定义来源API</label>
<label style="font-size:12px;color:#a09088;cursor:pointer;"><input id="search_enable_jina" type="checkbox" ${settings.enableJinaFetch?'checked':''
        }> 启用Jina网页全文抓取</label>
<label style="font-size:12px;color:#a09088;cursor:pointer;"><input id="search_smart_skip" type="checkbox" ${settings.smartSkip?'checked':''
        }> 智能跳过已知内容</label>
<label style="font-size:12px;color:#a09088;cursor:pointer;"><input id="search_ai_filter" type="checkbox" ${settings.aiFilter?'checked':''
        }> 启用AI过滤搜索结果</label></div>
...
<div style="color:#706058;font-size:10px;margin-bottom:8px;">支持任何兼容的搜索 API。URL 中用 <code>{keyword
        }</code> 作为搜索词占位符；可选用 <code>{language
        }</code> 作为语言占位符。</div>
<div style="display:grid;grid-template-columns:repeat(2,1fr);gap:8px 16px;">
...
<div><label for="search_api_body_template" style="font-size:11px;color:#706058;">POST Body 模板</label><textarea id="search_api_body_template" rows="2" placeholder='{
          "query": "{keyword}",
          "language": "{language}"
        }' style="width:100%;box-sizing:border-box;background:rgba(255,255,255,0.04);border:1px solid rgba(232,120,74,0.15);border-radius:6px;color:#e8ddd4;padding:5px 8px;font-size:12px;resize:vertical;">${escapeHtml(settings.searchApiBodyTemplate||'')
        }</textarea></div>
...
<div style="display:flex;gap:8px;align-items:center;"><select id="search_custom_model_select" ${state.husouRuntimeModels.length?'':'disabled'
        } style="flex:1;box-sizing:border-box;background:rgba(255,255,255,0.04);border:1px solid rgba(232,120,74,0.15);border-radius:6px;color:#e8ddd4;padding:5px 8px;font-size:12px;">${getHusouModelOptionsHtml(settings.customModel)
        }</select><input id="search_fetch_models_btn" type="button" value="${state.husouRuntimeLoading?'获取中…':'获取模型'}" ${state.husouRuntimeLoading?'disabled':''
        } style="padding:5px 12px;border:1px solid rgba(232,120,74,0.2);border-radius:6px;background:rgba(255,255,255,0.03);color:#a09088;cursor:pointer;font-size:12px;"></div>
...
<div id="search_engine_status" style="color:#706058;font-size:10px;margin-top:4px;">当前状态：🦊狐搜 已加载</div></div>`;
    ...
    function bindHusouPanelEvents(panel){
        ...
        if(testPreset)testPreset.addEventListener('click',()=>{readHusouSettingsFromPanel(panel);if(!state.husouSettings.searchPresetName){toast('未选择预设','warning');return;
          }try{getPreset(state.husouSettings.searchPresetName);toast(`预设读取成功：${state.husouSettings.searchPresetName
            }`,'success');
        ...
        if(manualBtn)manualBtn.addEventListener('click',async()=>{readHusouSettingsFromPanel(panel);const lastId=getFn('getLastMessageId')?.();if(lastId==null){toast('无法获取楼层','error');return;
          }state.husouLastHandledId=null;await husouManualSearch(lastId);
        });
        ...
        if(saveInj)saveInj.addEventListener('click',async()=>{const ta=g('injection_manager_textarea');if(!ta?.value.trim()){toast('内容为空','warning');return;
          }await husouInjectCustom(ta.value);
        });
    ...
    async function husouFetchModels(){
        ...
        try{const getModelList=getFn('getModelList');if(typeof getModelList==='function'){state.husouRuntimeModels=await getModelList({apiurl,key:s.customApiKey||''
            });
          }else{const headers=SillyTavern?.getRequestHeaders?.()||{};const resp=await fetch('/api/backends/chat-completions/status',
            {method:'POST',headers,body:JSON.stringify({reverse_proxy:apiurl,proxy_password:s.customApiKey||'',chat_completion_source:'openai'
              })
            });const json=await resp.json();state.husouRuntimeModels=(json?.data||[]).map(x=>String(x?.id??'').trim()).filter(Boolean);
          }state.husouRuntimeModels=[...new Set(state.husouRuntimeModels)
          ].sort();toast(state.husouRuntimeModels.length?`已获取 ${state.husouRuntimeModels.length
          } 个模型`:'模型列表为空',state.husouRuntimeModels.length?'success':'warning');
        }catch(e){toast(`获取失败：${e.message
          }`,'error');
        }finally{state.husouRuntimeLoading=false;
        }
      }
      // ==================== 事件 ====================
    function onGenStart(type,option,dryRun){if(dryRun||!state.enabled||window.__searchEngineBusy||!isThoughtVisible())return;state.isGenerating=true;updateBubbleUI();if(!state.isMini)disableAllBeauty();else disableAllMini();setThoughtVisible(false);const tid=setTimeout(async()=>{await forceRefresh(getCurrentLastMessageId());
        },CONFIG.HIDE_DELAY);state._timers.hide=tid;
      }
    function onGenEnd(mid){if(!state.enabled||window.__searchEngineBusy)return;state.isGenerating=false;updateBubbleUI();const tid=setTimeout(async()=>{setBeautyStyle(state.currentStyle,state.isExpanded);setThoughtVisible(true);await forceRefresh(getCurrentLastMessageId());
    ...
    function createToggleSwitch(promptId,onChange){const w=topDoc.createElement('span');w.style.cssText='display:inline-flex;gap: 0;border-radius: 6px;overflow:hidden;border: 1px solid rgba(232,
        120,
        74,
        0.25);flex-shrink: 0;';const onB=topDoc.createElement('span');onB.textContent='开';const offB=topDoc.createElement('span');offB.textContent='关';[onB,offB
        ].forEach(b=>{b.style.cssText='padding: 3px 10px;cursor:pointer;font-size: 11px;font-weight: 600;transition:all 0.15s;';
        });function up(){const e=isPromptEnabledInPreset(promptId);if(e){onB.style.background='rgba(232,
            120,
            74,
            0.25)';onB.style.color='#f0a070';offB.style.background='transparent';offB.style.color='#555';
          }else{onB.style.background='transparent';onB.style.color='#555';offB.style.background='rgba(232,
            120,
            74,
            0.25)';offB.style.color='#f0a070';
          }
        }onB.onclick=async()=>{await togglePromptById(promptId,true);up();if(onChange)onChange(true);
        };offB.onclick=async()=>{await togglePromptById(promptId,false);up();if(onChange)onChange(false);
        };w.appendChild(onB);w.appendChild(offB);up();return{wrapper:w,update:up
        };
      }
    function createLeftRightSwitch(lLabel,rLabel,lId,rId,onChange){const w=topDoc.createElement('span');w.style.cssText='display:inline-flex;gap: 0;border-radius: 6px;overflow:hidden;border: 1px solid rgba(232,
        120,
        74,
        0.25);flex-shrink: 0;';const lB=topDoc.createElement('span');lB.textContent=lLabel;const rB=topDoc.createElement('span');rB.textContent=rLabel;[lB,rB
        ].forEach(b=>{b.style.cssText='padding: 4px 12px;cursor:pointer;font-size: 11px;font-weight: 600;transition:all 0.15s;white-space:nowrap;';
        });function up(){const lOn=isPromptEnabledInPreset(lId);if(lOn){lB.style.background='rgba(232,
            120,
            74,
            0.25)';lB.style.color='#f0a070';rB.style.background='transparent';rB.style.color='#555';
          }else{lB.style.background='transparent';lB.style.color='#555';rB.style.background='rgba(232,
            120,
            74,
            0.25)';rB.style.color='#f0a070';
          }
        }lB.onclick=async()=>{await togglePromptById(lId,true);await togglePromptById(rId,false);up();if(onChange)onChange('left');
        };rB.onclick=async()=>{await togglePromptById(lId,false);await togglePromptById(rId,true);up();if(onChange)onChange('right');
        };w.appendChild(lB);w.appendChild(rB);up();return{wrapper:w,update:up
        };
      }
      // ==================== 大面板 ====================
    function openDashboard(){
        if(topDoc.getElementById('ss-dashboard'))return;
        const overlay=topDoc.createElement('div');overlay.id='ss-dash-overlay';overlay.style.cssText='position:fixed;inset: 0;background:rgba(0,
        0,
        0,
        0.55);z-index: 999998;backdrop-filter:blur(4px);-webkit-backdrop-filter:blur(4px);animation:ss-fadeIn 0.2s ease;';overlay.onclick=closeDashboard;
        ...
        -50%);width: 900px;max-height: 85vh;overflow-y:auto;background:rgba(18,
        15,
        17,
        0.97);border: 1px solid rgba(232,
        120,
        74,
        0.25);border-radius: 20px;padding: 24px 28px;z-index: 999999;color:#e8ddd4;font-size: 13px;box-shadow: 0 24px 80px rgba(0,
        0,
        0,
        0.7);display:flex;flex-direction:column;gap: 18px;animation:ss-scaleIn 0.25s cubic-bezier(0.34,
        1.56,
        0.64,
        1);';
        function sectionBox(){const d=topDoc.createElement('div');d.style.cssText='background:rgba(232,
          120,
          74,
          0.025);border: 1px solid rgba(232,
          120,
          74,
          0.1);border-radius: 10px;padding: 14px 16px;';return d;
        }
        ...
        function label(t,w='90px'){const s=topDoc.createElement('span');s.textContent=t;s.style.cssText=`font-size: 12px;color:#a09088;width:${w
          };flex-shrink: 0;text-align:right;`;return s;
        }
        const allUpdates=[];

        // Header
        const header=topDoc.createElement('div');header.style.cssText='display:flex;justify-content:space-between;align-items:center;padding-bottom: 14px;border-bottom: 1px solid rgba(232,
        120,
        74,
        0.15);';
        const titleSpan=topDoc.createElement('span');titleSpan.style.cssText='font-size: 15px;font-weight: 700;letter-spacing:0.03em;';titleSpan.innerHTML='<svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="#f0a070" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" style="vertical-align:-4px;margin-right:6px;"><path d="M12 2c-1.5 2-3 4-3 7 0 3 1.5 5 3 7"/><path d="M12 2c1.5 2 3 4 3 7 0 3-1.5 5-3 7"/><circle cx="12" cy="12" r="2" fill="#f0a070" stroke="none"/><path d="M5 8c1 1.5 2 3 3 4"/><path d="M19 8c-1 1.5-2 3-3 4"/></svg>🦊 玄狐中控';header.appendChild(titleSpan);const closeBtn=topDoc.createElement('span');closeBtn.textContent='✕';closeBtn.style.cssText='cursor:pointer;font-size: 16px;color:#706058;padding: 4px 8px;border-radius: 6px;transition:all 0.2s;';closeBtn.onmouseover=()=>{closeBtn.style.background='rgba(255,
          255,
          255,
          0.04)';closeBtn.style.color='#c0a090';
        };closeBtn.onmouseout=()=>{closeBtn.style.background='transparent';closeBtn.style.color='#706058';
        };closeBtn.onclick=closeDashboard;header.appendChild(closeBtn);dash.appendChild(header);
        ...
        const statusChip=topDoc.createElement('span');statusChip.id='ss-dash-status';statusChip.textContent=buildStatusText();statusChip.style.cssText='font-size: 11px;color:#706058;background:rgba(232,
        120,
        74,
        0.06);padding: 4px 16px;border-radius: 10px;display:inline-block;';
        ...
        function makeControl(labelText,labelWidth,ctrl){const r=row();r.style.justifyContent='space-between';const l=topDoc.createElement('span');l.textContent=labelText;l.style.cssText=`font-size: 12px;color:#a09088;width:${labelWidth
          };flex-shrink: 0;`;r.appendChild(l);r.appendChild(ctrl);return r;
        }
        const streamSw=(()=>{const w=topDoc.createElement('span');w.style.cssText='display:inline-flex;gap: 0;border-radius: 6px;overflow:hidden;border: 1px solid rgba(232,
          120,
          74,
          0.25);flex-shrink: 0;';const onB=topDoc.createElement('span');onB.textContent='开';const offB=topDoc.createElement('span');offB.textContent='关';[onB,offB
          ].forEach(b=>{b.style.cssText='padding: 3px 10px;cursor:pointer;font-size: 11px;font-weight: 600;transition:all 0.15s;';
          });const up=()=>{const e=state.enabled;if(e){onB.style.background='rgba(232,
              120,
              74,
              0.25)';onB.style.color='#f0a070';offB.style.background='transparent';offB.style.color='#555';
            }else{onB.style.background='transparent';onB.style.color='#555';offB.style.background='rgba(232,
          ...
          };onB.onclick=async()=>{state.enabled=true;localStorage.setItem(CONFIG.ENABLED_KEY,'true');bindEvents();if(!isStreamingEnabled())await setStreaming(true);updateBubbleUI();updateStatusChip();up();
          };offB.onclick=async()=>{state.enabled=false;localStorage.setItem(CONFIG.ENABLED_KEY,'false');unbindEvents();state.isGenerating=false;updateBubbleUI();updateStatusChip();up();
          };w.appendChild(onB);w.appendChild(offB);up();return{wrapper:w,update:up
          };
        })();
        thinkGrid.appendChild(makeControl('🌊 平滑流式','75px',streamSw.wrapper));
        const visSw=(()=>{const w=topDoc.createElement('span');w.style.cssText='display:inline-flex;gap: 0;border-radius: 6px;overflow:hidden;border: 1px solid rgba(232,
          120,
          74,
          0.25);flex-shrink: 0;';const onB=topDoc.createElement('span');onB.textContent='开';const offB=topDoc.createElement('span');offB.textContent='关';[onB,offB
          ].forEach(b=>{b.style.cssText='padding: 3px 10px;cursor:pointer;font-size: 11px;font-weight: 600;transition:all 0.15s;';
          });const up=()=>{const e=isThoughtVisible();if(e){onB.style.background='rgba(232,
              120,
              74,
              0.25)';onB.style.color='#f0a070';offB.style.background='transparent';offB.style.color='#555';
            }else{onB.style.background='transparent';onB.style.color='#555';offB.style.background='rgba(232,
          ...
          };onB.onclick=async()=>{setThoughtVisible(true);await forceRefresh(getCurrentLastMessageId());updateStatusChip();up();
          };offB.onclick=async()=>{setThoughtVisible(false);await forceRefresh(getCurrentLastMessageId());updateStatusChip();up();
          };w.appendChild(onB);w.appendChild(offB);up();return{wrapper:w,update:up
          };
        })();
        thinkGrid.appendChild(makeControl('👁 思维链可见','75px',visSw.wrapper));
        const sel=topDoc.createElement('select');sel.style.cssText='background:rgba(255,
        255,
        255,
        0.04);border: 1px solid rgba(232,
        120,
        74,
        0.2);border-radius: 6px;color:#e8ddd4;padding: 4px 8px;font-size: 12px;font-family:inherit;cursor:pointer;';['HUSHE','JIANYUE','BIAOLI'
        ].forEach(s=>{const o=topDoc.createElement('option');o.value=s;o.textContent=getStyleName(s).replace(/[🦊◈◇
          ]\s*/,'');o.selected=state.currentStyle===s;sel.appendChild(o);
        });sel.onchange=()=>selectStyle(sel.value);
        thinkGrid.appendChild(makeControl('🎨 切换样式','75px',sel));
        const expandSw=(()=>{const w=topDoc.createElement('span');w.style.cssText='display:inline-flex;gap: 0;border-radius: 6px;overflow:hidden;border: 1px solid rgba(232,
          120,
          74,
          0.25);flex-shrink: 0;';const onB=topDoc.createElement('span');onB.textContent='开';const offB=topDoc.createElement('span');offB.textContent='关';[onB,offB
          ].forEach(b=>{b.style.cssText='padding: 3px 10px;cursor:pointer;font-size: 11px;font-weight: 600;transition:all 0.15s;';
          });const up=()=>{const e=state.isExpanded;if(e){onB.style.background='rgba(232,
              120,
              74,
              0.25)';onB.style.color='#f0a070';offB.style.background='transparent';offB.style.color='#555';
            }else{onB.style.background='transparent';onB.style.color='#555';offB.style.background='rgba(232,
          ...
          };onB.onclick=async()=>{if(state.isMini)return;state.isExpanded=true;localStorage.setItem(CONFIG.EXPAND_KEY,'true');setBeautyStyle(state.currentStyle,true);await forceRefresh(getCurrentLastMessageId());updateStatusChip();up();
          };offB.onclick=async()=>{if(state.isMini)return;state.isExpanded=false;localStorage.setItem(CONFIG.EXPAND_KEY,'false');setBeautyStyle(state.currentStyle,false);await forceRefresh(getCurrentLastMessageId());updateStatusChip();up();
          };w.appendChild(onB);w.appendChild(offB);up();return{wrapper:w,update:up
          };
        })();
        thinkGrid.appendChild(makeControl('📖 默认展开','75px',expandSw.wrapper));
        const miniSw=(()=>{const w=topDoc.createElement('span');w.style.cssText='display:inline-flex;gap: 0;border-radius: 6px;overflow:hidden;border: 1px solid rgba(232,
          120,
          74,
          0.25);flex-shrink: 0;';const onB=topDoc.createElement('span');onB.textContent='开';const offB=topDoc.createElement('span');offB.textContent='关';[onB,offB
          ].forEach(b=>{b.style.cssText='padding: 3px 10px;cursor:pointer;font-size: 11px;font-weight: 600;transition:all 0.15s;';
          });const up=()=>{const e=state.isMini;if(e){onB.style.background='rgba(232,
              120,
              74,
              0.25)';onB.style.color='#f0a070';offB.style.background='transparent';offB.style.color='#555';
            }else{onB.style.background='transparent';onB.style.color='#555';offB.style.background='rgba(232,
          ...
          };onB.onclick=async()=>{state.isMini=true;localStorage.setItem(CONFIG.MINI_KEY,'true');setBeautyStyle(state.currentStyle,state.isExpanded);await forceRefresh(getCurrentLastMessageId());updateStatusChip();up();
          };offB.onclick=async()=>{state.isMini=false;localStorage.setItem(CONFIG.MINI_KEY,'false');setBeautyStyle(state.currentStyle,state.isExpanded);await forceRefresh(getCurrentLastMessageId());updateStatusChip();up();
          };w.appendChild(onB);w.appendChild(offB);up();return{wrapper:w,update:up
          };
        })();
        ...
        // 模块2: 快捷开关
        dash.appendChild(sectionTitle('🔧 快捷开关'));const quickBox=sectionBox();quickBox.style.cssText+='display:grid;grid-template-columns:repeat(3,
        1fr);gap: 8px 16px;';
        ...
        120,
        74,
        0.3);border-radius: 6px;background:rgba(232,
        120,
        74,
        0.1);color:#f0a070;cursor:pointer;font-size: 12px;font-family:inherit;transition:all 0.2s;';husouBtn.onmouseover=()=>{husouBtn.style.background='rgba(232,
          120,
          74,
          0.2)';
        };husouBtn.onmouseout=()=>{husouBtn.style.background='rgba(232,
          120,
          74,
          0.1)';
        };husouBtn.onclick=async()=>{if(!state.husouSettings)state.husouSettings=loadHusouSettings();const lastId=getFn('getLastMessageId')?.();if(lastId==null){toast('无法获取楼层','error');return;
          }state.husouLastHandledId=null;await husouManualSearch(lastId);refreshAnyHusouPanel();
        };husouRow.appendChild(husouLabel);husouRow.appendChild(husouBtn);quickBox.appendChild(husouRow);
        ...
        const clearBtn=topDoc.createElement('button');clearBtn.textContent='🧹 清理 Swipe';clearBtn.style.cssText='flex: 1;padding: 10px;border: 1px solid rgba(232,
        120,
        74,
        0.2);border-radius: 8px;background:rgba(255,
        255,
        255,
        0.03);color:#a09088;cursor:pointer;font-size: 12px;font-family:inherit;transition:all 0.2s;';clearBtn.onmouseover=()=>{clearBtn.style.background='rgba(232,
          120,
          74,
          0.08)';clearBtn.style.color='#e8ddd4';
        };clearBtn.onmouseout=()=>{clearBtn.style.background='rgba(255,
          255,
          255,
          0.03)';clearBtn.style.color='#a09088';
        };clearBtn.onclick=async()=>{const n=await clearAllSwipes();toast(n>0?`🧹 已清理 ${n
          } 个楼层的多余 swipe`:'✅ 没有需要清理的 swipe',n>0?'success':'info');
        };ctxBox.appendChild(clearBtn);
        const sumBtn=topDoc.createElement('button');sumBtn.textContent='📝 全文大总结';sumBtn.id='ss-dash-summary';sumBtn.style.cssText='flex: 1;padding: 10px;border: 1px solid rgba(232,
        120,
        74,
        0.2);border-radius: 8px;background:rgba(255,
        255,
        255,
        0.03);color:#a09088;cursor:pointer;font-size: 12px;font-family:inherit;transition:all 0.2s;';sumBtn.onmouseover=()=>{sumBtn.style.background='rgba(232,
          120,
          74,
          0.08)';sumBtn.style.color='#e8ddd4';
        };sumBtn.onmouseout=()=>{sumBtn.style.background='rgba(255,
          255,
          255,
          0.03)';sumBtn.style.color='#a09088';
        };sumBtn.onclick=()=>runFullSummary();ctxBox.appendChild(sumBtn);const hideAllBtn=topDoc.createElement('button');hideAllBtn.textContent='🙈 一键隐藏';hideAllBtn.style.cssText='flex: 1;padding: 10px;border: 1px solid rgba(232,
        120,
        74,
        0.2);border-radius: 8px;background:rgba(255,
        255,
        255,
        0.03);color:#a09088;cursor:pointer;font-size: 12px;font-family:inherit;transition:all 0.2s;';hideAllBtn.onmouseover=()=>{hideAllBtn.style.background='rgba(232,
          120,
          74,
          0.08)';hideAllBtn.style.color='#e8ddd4';
        };hideAllBtn.onmouseout=()=>{hideAllBtn.style.background='rgba(255,
          255,
          255,
          0.03)';hideAllBtn.style.color='#a09088';
        };hideAllBtn.onclick=async()=>{const glmi=getFn('getLastMessageId'),scm=getFn('setChatMessages');if(!glmi||!scm){toast('❌ 缺少 API','error');return;
          }const lastId=glmi();if(lastId<0){toast('⚠️ 无消息可隐藏','warning');return;
          }const updates=[];for(let i=0;i<=lastId;i++)updates.push({message_id:i,is_hidden: true
          });await scm(updates,
          {refresh:'affected'
          });toast(`🙈 已隐藏 0-${lastId
          } (共 ${updates.length
          } 条)`,'success');
        };ctxBox.appendChild(hideAllBtn);const unhideAllBtn=topDoc.createElement('button');unhideAllBtn.textContent='👁 清除隐藏';unhideAllBtn.style.cssText='flex: 1;padding: 10px;border: 1px solid rgba(232,
        120,
        74,
        0.2);border-radius: 8px;background:rgba(255,
        255,
        255,
        0.03);color:#a09088;cursor:pointer;font-size: 12px;font-family:inherit;transition:all 0.2s;';unhideAllBtn.onmouseover=()=>{unhideAllBtn.style.background='rgba(232,
          120,
          74,
          0.08)';unhideAllBtn.style.color='#e8ddd4';
        };unhideAllBtn.onmouseout=()=>{unhideAllBtn.style.background='rgba(255,
          255,
          255,
          0.03)';unhideAllBtn.style.color='#a09088';
        };unhideAllBtn.onclick=async()=>{const glmi=getFn('getLastMessageId'),scm=getFn('setChatMessages');if(!glmi||!scm){toast('❌ 缺少 API','error');return;
          }const lastId=glmi();if(lastId<0){toast('⚠️ 无消息','warning');return;
          }const updates=[];for(let i=0;i<=lastId;i++)updates.push({message_id:i,is_hidden: false
          });await scm(updates,
          {refresh:'affected'
          });toast(`👁 已清除隐藏 0-${lastId
          } (共 ${updates.length
          } 条)`,'success');
        };ctxBox.appendChild(unhideAllBtn);dash.appendChild(ctxBox);
...
refreshSummaryBtn.style.cssText = 'flex: 1;padding: 8px;border: 1px solid rgba(232,
        120,
        74,
        0.2);border-radius: 6px;background:rgba(255,
        255,
        255,
        0.03);color:#a09088;cursor:pointer;font-size: 12px;font-family:inherit;transition:all 0.2s;';
refreshSummaryBtn.onmouseover = () => {
    refreshSummaryBtn.style.background = 'rgba(232,
          120,
          74,
          0.08)';
...
refreshSummaryBtn.onmouseout = () => {
    refreshSummaryBtn.style.background = 'rgba(255,
          255,
          255,
          0.03)';
...
saveSummaryBtn.style.cssText = 'flex: 1;padding: 8px;border: 1px solid rgba(232,
        120,
        74,
        0.3);border-radius: 6px;background:rgba(232,
        120,
        74,
        0.1);color:#f0a070;cursor:pointer;font-size: 12px;font-family:inherit;transition:all 0.2s;';
saveSummaryBtn.onmouseover = () => {
    saveSummaryBtn.style.background = 'rgba(232,
          120,
          74,
          0.2)';
        };
...
clearSummaryBtn.style.cssText = 'flex: 1;padding: 8px;border: 1px solid rgba(139,
        0,
        0,
        0.3);border-radius: 6px;background:rgba(139,
        0,
        0,
        0.15);color:#d08080;cursor:pointer;font-size: 12px;font-family:inherit;transition:all 0.2s;';
clearSummaryBtn.onmouseover = () => {
    clearSummaryBtn.style.background = 'rgba(139,
          0,
          0,
          0.3)';
        };
...
dash.appendChild(summaryBox);
        ...
        const autoBeatRow=row();autoBeatRow.appendChild(label('⚡ 自动拷打','75px'));const autoBeatSw=(()=>{const w=topDoc.createElement('span');w.style.cssText='display:inline-flex;gap: 0;border-radius: 6px;overflow:hidden;border: 1px solid rgba(232,
          120,
          74,
          0.25);flex-shrink: 0;';const onB=topDoc.createElement('span');onB.textContent='开';const offB=topDoc.createElement('span');offB.textContent='关';[onB,offB
          ].forEach(b=>{b.style.cssText='padding: 3px 10px;cursor:pointer;font-size: 11px;font-weight: 600;transition:all 0.15s;';
          });const up=()=>{const e=state.autoBeat;if(e){onB.style.background='rgba(232,
              120,
              74,
              0.25)';onB.style.color='#f0a070';offB.style.background='transparent';offB.style.color='#555';
            }else{onB.style.background='transparent';onB.style.color='#555';offB.style.background='rgba(232,
          ...
          };onB.onclick=()=>{state.autoBeat=true;localStorage.setItem(CONFIG.AUTO_BEAT_KEY,'true');up();
          };offB.onclick=()=>{state.autoBeat=false;localStorage.setItem(CONFIG.AUTO_BEAT_KEY,'false');up();
          };w.appendChild(onB);w.appendChild(offB);up();return{wrapper:w,update:up
          };
        })();autoBeatRow.appendChild(autoBeatSw.wrapper);beatBox.appendChild(autoBeatRow);
        ...
        });qualRow.appendChild(qualSw.wrapper);beatBox.appendChild(qualRow);
        const commentRow=topDoc.createElement('div');commentRow.id='ss-dash-beat-comment-row';commentRow.style.display=state.beatMode==='bad'?'':'none';const ci=topDoc.createElement('textarea');ci.placeholder='吐槽一下哪里写得不好...也可以不填让狐神抚帮你吐槽哦';ci.value=state.beatDraft;ci.style.cssText='width: 100%;background:rgba(255,
        255,
        255,
        0.04);border: 1px solid rgba(232,
        120,
        74,
        0.2);border-radius: 8px;color:#e8ddd4;padding: 8px 10px;font-size: 12px;font-family:inherit;resize:vertical;box-sizing:border-box;min-height: 40px;';ci.oninput=()=>{state.beatDraft=ci.value;localStorage.setItem(CONFIG.BEAT_DRAFT_KEY,state.beatDraft);
        };commentRow.appendChild(ci);beatBox.appendChild(commentRow);
        const goodCommentRow=topDoc.createElement('div');goodCommentRow.id='ss-dash-beat-good-comment-row';goodCommentRow.style.display=state.beatMode==='good'?'':'none';const gci=topDoc.createElement('textarea');gci.placeholder='夸夸哪里写得好...';gci.value=state.beatGoodDraft||'';gci.style.cssText='width: 100%;background:rgba(255,
        255,
        255,
        0.04);border: 1px solid rgba(232,
        120,
        74,
        0.2);border-radius: 8px;color:#e8ddd4;padding: 8px 10px;font-size: 12px;font-family:inherit;resize:vertical;box-sizing:border-box;min-height: 40px;';gci.oninput=()=>{state.beatGoodDraft=gci.value;localStorage.setItem('SPreset_BeatGoodDraft',state.beatGoodDraft);
        };goodCommentRow.appendChild(gci);beatBox.appendChild(goodCommentRow);
        const btnsRow=row();btnsRow.style.gap='12px';const runBtn=topDoc.createElement('button');runBtn.textContent='🔨 立即分析';runBtn.id='ss-dash-beat-run';runBtn.style.cssText='flex: 1;padding: 10px;border: 1px solid rgba(232,
        120,
        74,
        0.3);border-radius: 8px;background:rgba(232,
        120,
        74,
        0.1);color:#f0a070;cursor:pointer;font-size: 12px;font-family:inherit;transition:all 0.2s;';runBtn.onmouseover=()=>{runBtn.style.background='rgba(232,
          120,
          74,
          0.2)';
        };runBtn.onmouseout=()=>{runBtn.style.background='rgba(232,
          120,
          74,
          0.1)';
        };runBtn.onclick=()=>runBeatMode();btnsRow.appendChild(runBtn);const memBtn=topDoc.createElement('button');memBtn.textContent='📋 长期记忆管理';memBtn.style.cssText='flex: 1;padding: 10px;border: 1px solid rgba(232,
        120,
        74,
        0.2);border-radius: 8px;background:rgba(255,
        255,
        255,
        0.03);color:#a09088;cursor:pointer;font-size: 12px;font-family:inherit;transition:all 0.2s;';memBtn.onmouseover=()=>{memBtn.style.background='rgba(232,
          120,
          74,
          0.08)';memBtn.style.color='#e8ddd4';
        };memBtn.onmouseout=()=>{memBtn.style.background='rgba(255,
          255,
          255,
          0.03)';memBtn.style.color='#a09088';
        };memBtn.onclick=()=>toggleBeatMemoryPanel();btnsRow.appendChild(memBtn);beatBox.appendChild(btnsRow);dash.appendChild(beatBox);

        // 模块5: 预设选项控制
        dash.appendChild(sectionTitle('⚙️ 预设选项控制'));const presetBox=sectionBox();presetBox.style.cssText+='display:grid;grid-template-columns:repeat(auto-fill, minmax(260px,
        1fr));gap: 10px 20px;';
    ...
    sel2.style.cssText='background:rgba(255,
          255,
          255,
          0.04);border: 1px solid rgba(232,
          120,
          74,
          0.2);border-radius: 6px;color:#e8ddd4;padding: 5px 8px;font-size: 12px;font-family:inherit;cursor:pointer;width: 170px;text-align:center;';
...
dash.appendChild(presetBox);
        ...
        for(const ce of CONFIG.CUSTOM_EDIT_IDS){const btn=topDoc.createElement('button');btn.textContent=ce.name;btn.style.cssText='padding: 8px 14px;border: 1px solid rgba(232,
          120,
          74,
          0.2);border-radius: 8px;background:rgba(255,
          255,
          255,
          0.03);color:#a09088;cursor:pointer;font-size: 12px;font-family:inherit;transition:all 0.2s;';btn.onmouseover=()=>{btn.style.background='rgba(232,
            120,
            74,
            0.08)';btn.style.color='#e8ddd4';
          };btn.onmouseout=()=>{btn.style.background='rgba(255,
            255,
            255,
            0.03)';btn.style.color='#a09088';
          };btn.onclick=()=>openCustomEditPanel(ce.id, ce.name, ce.knownVar || '');customBox.appendChild(btn);
        }dash.appendChild(customBox);
        ...
        for(const t of CONFIG.KILL_TOGGLES){const r=row();const l=topDoc.createElement('span');l.textContent=t.name;l.style.cssText='font-size: 12px;color:#a09088;';r.appendChild(l);const sw=createToggleSwitch(t.id);allUpdates.push(sw.update);r.appendChild(sw.wrapper);killBox.appendChild(r);
        }dash.appendChild(killBox);

        // 模块8: 狐析
        dash.appendChild(sectionTitle('🦊 狐析（用户偏好分析）'));const hushenBox=sectionBox();hushenBox.style.cssText+='display:flex;gap: 12px;';
        const hushenBtn=topDoc.createElement('button');hushenBtn.textContent='🦊 打开狐析面板';hushenBtn.style.cssText='flex: 1;padding: 10px;border: 1px solid rgba(232,
        120,
        74,
        0.2);border-radius: 8px;background:rgba(255,
        255,
        255,
        0.03);color:#a09088;cursor:pointer;font-size: 12px;font-family:inherit;transition:all 0.2s;';hushenBtn.onmouseover=()=>{hushenBtn.style.background='rgba(232,
          120,
          74,
          0.08)';hushenBtn.style.color='#e8ddd4';
        };hushenBtn.onmouseout=()=>{hushenBtn.style.background='rgba(255,
          255,
          255,
          0.03)';hushenBtn.style.color='#a09088';
        };hushenBtn.onclick=()=>openHushenPanel();hushenBox.appendChild(hushenBtn);dash.appendChild(hushenBox);

        // 模块9: 狐搜
        dash.appendChild(sectionTitle('🦊 狐搜（外部搜索）'));const husouBox=sectionBox();husouBox.style.cssText+='display:flex;gap: 12px;';
        const husouPanelBtn=topDoc.createElement('button');husouPanelBtn.textContent='🦊 打开狐搜面板';husouPanelBtn.style.cssText='flex: 1;padding: 10px;border: 1px solid rgba(232,
        120,
        74,
        0.2);border-radius: 8px;background:rgba(255,
        255,
        255,
        0.03);color:#a09088;cursor:pointer;font-size: 12px;font-family:inherit;transition:all 0.2s;';husouPanelBtn.onmouseover=()=>{husouPanelBtn.style.background='rgba(232,
          120,
          74,
          0.08)';husouPanelBtn.style.color='#e8ddd4';
        };husouPanelBtn.onmouseout=()=>{husouPanelBtn.style.background='rgba(255,
          255,
          255,
          0.03)';husouPanelBtn.style.color='#a09088';
        };husouPanelBtn.onclick=()=>openHusouPanel();husouBox.appendChild(husouPanelBtn);dash.appendChild(husouBox);

        topDoc.body.appendChild(overlay);topDoc.body.appendChild(dash);
        setTimeout(()=>{allUpdates.forEach(fn=>fn());
        },
        50);
      }
    ...
    async function selectStyle(style){if(state.currentStyle===style)return;state.currentStyle=style;localStorage.setItem(CONFIG.STYLE_KEY,style);setBeautyStyle(style,state.isExpanded);await forceRefresh(getCurrentLastMessageId());updateBubbleUI();updateStatusChip();
      ...
      // ==================== 浮窗 CSS ====================
    const BUBBLE_CSS=`<style id="ss-fox-styles">@keyframes ss-fadeIn{from{opacity: 0;
        }to{opacity: 1;
        }
      }@keyframes ss-scaleIn{from{opacity: 0;transform:translate(-50%,
          -50%) scale(0.9);
        }to{opacity: 1;transform:translate(-50%,
          -50%) scale(1);
        }
      }#ss-float-bubble{position:fixed;width: 44px;height: 44px;border-radius: 50%;cursor:pointer;display:flex;align-items:center;justify-content:center;font-size: 18px;user-select:none;-webkit-user-select:none;z-index: 1000000;touch-action:none;background:linear-gradient(145deg,rgba(24,
        18,
        20,
        0.95),rgba(16,
        12,
        14,
        0.95));border: 1.2px solid rgba(255,
        255,
        255,
        0.1);box-shadow: 0 4px 24px rgba(0,
        0,
        0,
        0.5),inset 0 1px 0 rgba(255,
        255,
        255,
        0.03);transition:transform 0.35s cubic-bezier(0.18,
        0.89,
        0.32,
        1.28),border-color 0.4s ease,box-shadow 0.4s ease;
      }#ss-float-bubble:hover{transform:scale(1.08);
      }#ss-float-bubble.enabled{border-color:rgba(232,
        120,
        74,
        0.5);box-shadow: 0 4px 24px rgba(0,
        0,
        0,
        0.5),
        0 0 18px 3px rgba(232,
        120,
        74,
        0.3),inset 0 1px 0 rgba(255,
        255,
        255,
        0.03);
      }#ss-float-bubble.generating{border-color:rgba(232,
        150,
        100,
        0.7)!important;box-shadow: 0 4px 24px rgba(0,
        0,
        0,
        0.5),
        0 0 28px 6px rgba(232,
        140,
        90,
        0.45),inset 0 1px 0 rgba(255,
        255,
        255,
        0.03)!important;
      }#ss-float-bubble.generating: :after{content:'';position:absolute;inset: -5px;border-radius: 50%;border: 2px solid transparent;border-top-color:rgba(232,
        150,
        100,
        0.5);animation:ss-spin-ring 1.5s linear infinite;
      }#ss-float-bubble .bubble-dot{position:absolute;top: 3px;right: 3px;width: 8px;height: 8px;border-radius: 50%;background:#444;border: 1.5px solid rgba(0,
        0,
        0,
        0.6);transition:all 0.35s ease;
      }#ss-float-bubble.enabled .bubble-dot{background:#f0a070;box-shadow: 0 0 8px rgba(240,
        160,
        112,
        0.7);
      }#ss-float-bubble.generating .bubble-dot{background:#f0b890;box-shadow: 0 0 10px rgba(240,
        180,
        140,
        0.8);animation:ss-dot-pulse 0.8s ease-in-out infinite;
      }@keyframes ss-spin-ring{from{transform:rotate(0deg);
      ...
      }#ss-dashboard: :-webkit-scrollbar{width: 4px;
      }#ss-dashboard: :-webkit-scrollbar-track{background:transparent;
      }#ss-dashboard: :-webkit-scrollbar-thumb{background:rgba(232,
        120,
        74,
        0.2);border-radius: 2px;
      }#ss-hushen-panel: :-webkit-scrollbar{width: 4px;
      }#ss-hushen-panel: :-webkit-scrollbar-track{background:transparent;
      }#ss-hushen-panel: :-webkit-scrollbar-thumb{background:rgba(232,
        120,
        74,
        0.2);border-radius: 2px;
      }#ss-husou-panel: :-webkit-scrollbar{width: 4px;
      }#ss-husou-panel: :-webkit-scrollbar-track{background:transparent;
      }#ss-husou-panel: :-webkit-scrollbar-thumb{background:rgba(232,
        120,
        74,
        0.2);border-radius: 2px;
    ...
    async function initUI(){
        ...
        bubble.addEventListener('pointerup',(e)=>{if(!dragging)return;dragging=false;bubble.style.transform='';bubble.style.pointerEvents='';bubble.style.transition='';if(dragMoved){const rect=bubble.getBoundingClientRect();bubble.style.left=rect.left+'px';bubble.style.top=rect.top+'px';bubble.style.right='auto';const side=(rect.left+rect.width/2)<topWindow.innerWidth/2?'left':'right';savePanelConfig({bubbleTop:rect.top+'px',bubbleSide:side
            });dragJustEnded=true;setTimeout(()=>dragJustEnded=false,
            150);
          }document.body.focus();
        });
    ...
    for (const id of panelIds) {
        ...
        panel.style.minHeight = `${Math.min(fallbackH, viewportH - gap * 2)
          }px`;
        }
    ...
    if (dash) {
        ...
        dash.querySelectorAll('div').forEach(el => {
            ...
            if (
                st.includes('grid-template-columns:repeat(3,
            1fr)') ||
                st.includes('grid-template-columns: repeat(3,
            1fr)') ||
    ...
    if (husou) {
        husou.querySelectorAll('div').forEach(el => {
            ...
            if (
                st.includes('grid-template-columns:repeat(2,
            1fr)') ||
                st.includes('grid-template-columns: repeat(2,
            1fr)') ||
...
#ss-dashboard {
    ...
    background:
        radial-gradient(circle at top left, rgba(232,
          120,
          74,
          0.10), transparent 34%),
        linear-gradient(145deg, rgba(22,
          17,
          19,
          0.985), rgba(12,
          10,
...
#ss-dashboard > div:first-child {
    ...
    background:
        linear-gradient(180deg, rgba(22,
          17,
          19,
          0.98), rgba(22,
          17,
...
.ss-section-title: :after {
    ...
    flex: 1 !important;
    background: linear-gradient(90deg, rgba(232,
          120,
          74,
          0.22), transparent) !important;
        }
...
#ss-dash-status {
    ...
    box-shadow: inset 0 1px 0 rgba(255,
        ...
        /* 快捷开关区域 */
.ss-quick-grid {
    grid-template-columns: repeat(auto-fit, minmax(245px,
          1fr)) !important;
...
.ss-context-row {
    ...
    grid-template-columns: repeat(auto-fit, minmax(145px,
          1fr)) !important;
    gap: 10px !important;
        }
        /* 大总结 textarea */
...
#ss-hushen-panel {
    ...
    background:
        radial-gradient(circle at top right, rgba(232,
          120,
          74,
          0.11), transparent 35%),
        linear-gradient(145deg, rgba(22,
...
.ss-hushen-actions {
    ...
    background: linear-gradient(180deg, transparent, rgba(18,
          14,
          16,
          0.96) 35%) !important;
        }
...
#ss-float-bubble {
    background:
        radial-gradient(circle at 35% 25%, rgba(255,
          210,
          170,
          0.16), transparent 35%),
        linear-gradient(145deg, rgba(31,
          23,
          26,
          0.98), rgba(13,
          10,
...
.ss-husou-advanced-details[open
        ] summary {
    border-bottom: 1px solid rgba(232,
          120,
          74,
          0.12) !important;
...
@media (max-width: 760px) {
    ...
    function enhanceDashboardUI() {
        ...
        const score = (text) => {
            const idx = order.findIndex(k => text.includes(k.replace(/[📡🔧⚙️✏️😡📦📋🔨🦊
          ]/g, '').trim()) || text.includes(k));
    ...
    panel.querySelectorAll('label').forEach(label => {
        ...
        label.style.border = '1px solid rgba(232,
          120,
          74,
          0.12)';
        label.style.borderRadius = '10px';
        label.style.background = 'rgba(255,
          255,
          255,
          0.025)';
...
function foldHusouCustomSearchAdvanced(panel) {
    ...
    details.open = false;
    details.style.cssText = 'grid-column: 1/-1;margin-top: 8px;border: 1px solid rgba(232,
        120,
        74,
        0.13);border-radius: 12px;background:rgba(255,
        255,
        255,
        0.025);overflow:hidden;';
    ...
    inner.style.cssText = 'display:grid;grid-template-columns:repeat(2,
        1fr);gap: 8px 16px;padding: 0 12px 12px;';

    const firstField = advancedFields[
          0
        ];
    ...
    async function init(){
        ...
        const initTimer=setTimeout(async()=>{
            ...
            if(state.enabled){bindEvents();if(!isStreamingEnabled())await setStreaming(true);log('✅ 已启用');
          }else{log('待开启');
          }
            updateBubbleUI();
    ...
    else{const ck=setInterval(()=>{if(typeof SillyTavern!=='undefined'){clearInterval(ck);init();
          }
        },
        500);
      }
